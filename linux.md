...
* [**Java, max user processes, open files | 우아한형제들 기술블로그**](https://techblog.woowahan.com/2569/)
...
* [리누스 토발즈가 보는 ‘리눅스커널과 러스트, AI, 개발자’ – 바이라인네트워크](https://byline.network/2025/11/5-339/)
  * [IT 인프라 엔지니어 그룹 | 일부 오타와 번역체가 있긴 하지만.. | Facebook](https://www.facebook.com/groups/InfraEngineer/permalink/4095473164100787/)
...
* [Setting Up the Perfect Developer Environment on Linux for 2025 - YouTube](https://www.youtube.com/watch?v=hKGPH9C-EFc)
...
* [7 Amazing CLI Tools You Need To Try - YouTube](https://www.youtube.com/watch?v=mmqDYw9C30I) fzf, bat, delta, eza, tldr, thefuck, zoxide
...
* `ping`
  ...
  * [How to Use the arping Command on Linux](https://www.howtogeek.com/813741/linux-arping-command/)
* pipe
...
* `ps`
  ...
  * `diff <(ps -aux) <(ps -ux)` [linux process substitution이 어떻게 동작하는지 간단하게 알아봅시다](https://codingdog.tistory.com/entry/linux-process-substitution%EC%9D%B4-%EC%96%B4%EB%96%BB%EA%B2%8C-%EB%8F%99%EC%9E%91%ED%95%98%EB%8A%94%EC%A7%80-%EA%B0%84%EB%8B%A8%ED%95%98%EA%B2%8C-%EC%95%8C%EC%95%84%EB%B4%85%EC%8B%9C%EB%8B%A4)
    ...
    * [Command vs. Process substitution in Bash - explaining the difference | You Suck at Programming - YouTube](https://www.youtube.com/watch?v=f3eIK5xk4vg)
      * Command Substitution `$(cmd)`은 출력을 문자열로 치환, Process Substitution `<(cmd)`은 출력을 임시 파일 경로로 제공. 두 개념의 차이와 각각 언제 쓰는지 설명
...
* `tcpdump`
  ...
  * [네트워크 패킷 덤프 - tcpdump (1)](https://naleejang.tistory.com/257)
  * [네트워크 패킷 덤프 - tcpdump (2)](https://naleejang.tistory.com/260)
* `tee`
...
* [CLI 개발 생산성 향상 오픈소스 도구들 | HoJin Ha](https://www.linkedin.com/posts/mimul_cli-%EA%B0%9C%EB%B0%9C-%EC%83%9D%EC%82%B0%EC%84%B1-%ED%96%A5%EC%83%81-%EC%98%A4%ED%94%88%EC%86%8C%EC%8A%A4-%EB%8F%84%EA%B5%AC%EB%93%A4-1-zoxide-%EB%B9%A0%EB%A5%B8-%EC%9D%B4%EB%8F%99-share-7456884367098003456-FILN)
...
* [bpf를 이용한 성능분석 | GeekNews](https://news.hada.io/topic?id=88)
* [BPF : 새로운 타입의 소프트웨어 | GeekNews](https://news.hada.io/topic?id=1011)
* [eBPF rethinking the Linux Kernel | GeekNews](https://news.hada.io/topic?id=1958)
* [eBPF 공식 사이트 오픈 | GeekNews](https://news.hada.io/topic?id=2661)
...
* [ebpfsnitch: Linux Application Level Firewall based on eBPF and NFQUEUE.](https://github.com/harporoeder/ebpfsnitch)
  * [eBPFSnitch - 리눅스용 어플리케이션 방화벽 | GeekNews](https://news.hada.io/topic?id=3894)
...
* [pulsar: A modular and blazing fast runtime security framework for the IoT, powered by eBPF.](https://github.com/Exein-io/pulsar)
...
* [5 Underrated CLI Tools That Made My Terminal Experience Better - YouTube](https://www.youtube.com/watch?v=II17TPAb4AQ)
  * [leaf : Terminal Markdown previewer, GUI-like experience](https://leaf.rivolink.mg/)
...
* [astroterm: A planetarium for your terminal! Explore stars, planets, constellations, and more, all rendered right in the command line—no telescope required. ✨🪐](https://github.com/da-luce/astroterm)
...
* [Localtunnel ~ Expose yourself to the world](https://localtunnel.github.io/www/)
  ...
  * [외부 망에서 localtunnel 사용하여 Localhost 접속하기](https://velog.io/@hn04147/%EC%99%B8%EB%B6%80-%EB%A7%9D%EC%97%90%EC%84%9C-localtunnel-%EC%82%AC%EC%9A%A9%ED%95%98%EC%97%AC-Localhost-%EC%A0%91%EC%86%8D%ED%95%98%EA%B8%B0)
...
* [Termix](https://docs.termix.site/)
  * [LukeGus/Termix: Termix is a web-based server management platform with SSH terminal, tunneling, and file editing capabilities.](https://github.com/LukeGus/Termix)
...
* [Tmux - 터미널을 더욱 효율적으로! - YouTube](https://www.youtube.com/watch?v=iTyjTM4Gujg)
