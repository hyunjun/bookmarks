...
* [개발 미션과 함께 읽는 클린 코드 | 우아한형제들 기술블로그](https://techblog.woowahan.com/2620/) clean code 책을 읽고 진행한 refactoring 정리
...
* [5월 우아한 Tech 세미나 후기 | 우아한형제들 기술블로그](https://techblog.woowahan.com/2627/) 성능, 라이센스, 모니터링
...
* [그냥 자바를 쓰세요 | GeekNews](https://news.hada.io/topic?id=17607)
...
* JDBC
  ...
  * [JDBC로 실행되는 SQL에 자동으로 프로젝트 정보 주석 남기기 | 우아한형제들 기술블로그](https://techblog.woowahan.com/2584/)
...
* [Netty - Using as a generic library](http://netty.io/wiki/using-as-a-generic-library.html)
  ...
  * [우리도 채팅있으면 좋을 것 같아요. | 우아한형제들 기술블로그](https://techblog.woowahan.com/2681/)
...
* [5. Stream API in java 8 Example Tutorial || Java 8 Streams Tutorials || JAVA 8 Tutorials || APIPOTHI - YouTube](https://www.youtube.com/watch?v=zUQbbYwn5c4)
...
* [Jetbrains Cool Tips - Part. 1) Handy Hotkeys with Life Hacking Settings](https://ebay-korea.tistory.com/90)
...
* [Amazon Corretto - No-cost, multiplatform, production-ready distribution of OpenJDK](https://aws.amazon.com/corretto/)
  ...
  * [Amazon Corretto OpenJDK를 사용한 Java 기반 애플리케이션 컨테이너 경량화 | AWS 기술 블로그](https://aws.amazon.com/ko/blogs/tech/amazon-corretto-base-container-diet/)
...
* [**도움이 될수도 있는 JVM memory leak 이야기 | 우아한형제들 기술블로그**](https://techblog.woowahan.com/2628/)
...
* [Loom: https://openjdk.org/projects/loom ](https://github.com/openjdk/loom)
  ...
  * [Java Project Loom: Why Should I Care? • Erwin de Gier • GOTO 2023 - YouTube](https://www.youtube.com/watch?v=ylxRLx9BuWA)
    ...
    * [자바 프로젝트 룸: 내가 왜 관심을 가져야 할까? - 에르빈 드 기어 - GOTO 2023 | 완벽한 영상요약, 릴리스에이아이 | Lilys AI](https://lilys.ai/digest/395113?sId=ylxRLx9BuWA)
      ...
      * 6.💻 가상 스레드와 동기화 블록, 프로그래밍 잠금에 대한 설명
        ...
        * 동기화 블록 활용, `Thread.sleep`에 대한 설명과 함께 동기화 메서드 내에서 처리하는 경우 Main thread를 차단시키는 문제 등을 세부적으로 다룸
        * 가상 스레드를 활용할 때는 reentrant lock을 검토하여 동기화 메서드 내의 블록을 준비하는 것이 중요
...
* [Dynamic Constants — Oxymoron or Promising JVM Feature? • Evgeny Mandrikov • GOTO 2023 - YouTube](https://www.youtube.com/watch?v=9hDsylc3Rvc)
  ...
  * [동적 상수 - 모순인가, 아니면 유망한 JVM 기능인가? - 에브게니 만드리코프 - GOTO 2023 | 완벽한 영상요약, 릴리스에이아이 | Lilys AI](https://lilys.ai/digest/460801?sId=9hDsylc3Rvc)
    ...
    * 2. 자바 버전8의 람다와 ConstantDynamic 사용 비교
    ...
    * 6. Java Version 9 변경에 따른 static final field 문제와 해결책
    ...
    * 8.️ JVM에서 동적 상수 문제와 해결 방법
      * 자바 JVM에 도입된 Coni는 *매직 비행*을 없앨 수 있는 좋은 기능
      * 동적 상수를 사용하면 *클래스 필드로 노출*되지 않기 때문에, 리플렉션을 통해 볼 수 없어서, 직렬화 프레임워크에서 좋은 부작용 발생
      * 초기 버전에서 일부 문제는 있었지만, 실제 사용자들이 발견하고 동적 상수로 인한 JVM 충돌 문제는 *OpenJDK 13에서 수정*
      * 동적 상수 문제가 해결되었지만, *클래스의 정적 초기화*와 연결된 부스트랩 메소드 사용 시의 문제 등은 여전히 주의 필요
      * 에러 방출을 없애는 대안을 찾아야 하며, 사용자에게 설정 노출 필요
    * 9. Java 언어에서 동적 상수 사용 예시와 그 장점
      ...
      * *ASM*과 같은 메소드가 동일한 람다로 사용될 때, 동적 상수를 활용하면 초기화 오버헤드 감소
    ...
    * 10. 자바 Virtual Machine에서의 상수, 배열, 메소드 제한
      * 자바 Virtual Machine에서는 Class 내의 필드 수가 *65,536개*로 제한, 배열의 크기 역시 *Integer.MAX_INT*로 제한
      * HotSpot JVM에서 배열의 크기는 *Integer.MAX_INT*에서 2 또는 3을 뺀 값으로 제한되며 메소드 크기는 *65,000명령어*로 제한
      * 실제로는 상수의 수는 32,000보다 적고, 다른 제한들에 가까워질 수 있지만, 구체적인 구현에 따라 다를 수 있음
    * 11. 자바 컴파일러의 트릭: 스위치 안정성을 유지하는 방법
    ...
    * 13. 새로운 Java 및 JVM 기능 속도론 성장과 중요도 팁
...
* [Feign makes writing java http clients easier](https://github.com/OpenFeign/feign)
  ...
  * [feign 좀더 나아가기 | 우아한형제들 기술블로그](https://techblog.woowahan.com/2657/)
  * [Feign 코드 분석과 서버 성능 개선](https://toss.tech/article/engineering-note-3)
* [Fig - Java elegant supplement](http://wapatesh.github.io/fig/)
* [fireball: High-performance file transfering service](https://github.com/joosing/fireball)
  * [Fireball: High-performance large file transfer open source project](https://velog.io/@joosing/fireball-high-performance-large-file-transfer-opensource-project)
  * [Fireball: 고성능 대용량 파일 전송 오픈소스 프로젝트](https://velog.io/@joosing/fireball-high-performance-large-file-transfer-opensource-project-kor)
...
* Gradle
  ...
  * [buildSrc를 적용한 Gradle의 Dependency Update하기](https://cliearl.github.io/posts/android/buildsrc-gradle-dependency-update/)
...
* [JaCoCo Java Code Coverage Library](https://www.jacoco.org/jacoco/)
  * [Java, Code Coverage: Scandals, Intrigues & Investigations • Evgeny Mandrikov • GOTO 2023 - YouTube](https://www.youtube.com/watch?v=SQqam3ARD_k)
    * [VidiGo Java, Code Coverage: Scandals, Intrigues & Investi](https://vidigo.ai/share/summary/867d2d579f8e)
    * [자바, 코드 커버리지: 스캔들, 음모 및 조사 - Evgeny Mandrikov - GOTO 2023 | 완벽한 영상요약, 릴리스에이아이 | Lilys AI](https://lilys.ai/digest/821467)
...
* Jenkins
  ...
  * [Jenkins Tutorial — Part 1 — Pipelines | by Saeid Bostandoust | ITNEXT](https://itnext.io/jenkins-tutorial-part-1-pipelines-bd1397cf5509)
  * [Jenkins Tutorial — Part 2 — Pipeline Variables | by Saeid Bostandoust | ITNEXT](https://itnext.io/jenkins-tutorial-part-2-pipeline-variables-5e4783aa2c07)
  * [Jenkins Tutorial — Part 3 — Parameterized Pipeline | by Saeid Bostandoust | ITNEXT](https://itnext.io/jenkins-tutorial-part-3-parameterized-pipeline-3898643ac6ad)
  * [Jenkins Tutorial — Part 4 — Post Actions | by Saeid Bostandoust | ITNEXT](https://itnext.io/jenkins-tutorial-part-4-post-actions-e5d0ef1e3c39)
  * [Jenkins Tutorial — Part 5 — When Conditions | by Saeid Bostandoust | ITNEXT](https://itnext.io/jenkins-tutorial-part-5-when-conditions-76e61fc8ac0e)
  ...
  * [CI/CD Jenkins 와 Nginx 를 활용한 Blue/Green 자동화 배포 아키텍처를 수동으로 구축하기 (feat. SpringBoot)](https://velog.io/@msung99/CICD-Jenkins-%EC%99%80-Nginx-%EB%A5%BC-%ED%99%9C%EC%9A%A9%ED%95%9C-BlueGreen-%EB%AC%B4%EC%A4%91%EB%8B%A8-%EB%B0%B0%ED%8F%AC-%EC%9E%90%EB%8F%99%ED%99%94-%EC%95%84%ED%82%A4%ED%85%8D%EC%B2%98-%EA%B5%AC%EC%B6%95)
  * [Jenkins CI/CD Pipeline - SonarQube, Docker, Github Webhooks on AWS | Resume Project | English - YouTube](https://www.youtube.com/watch?v=361bfIvXMBI)
  * [CI/CD Jenkins와 Gitea 연동](https://junyharang.tistory.com/385)
  * [Jenkins 성능 개선 part1 - 캐싱 적용](https://ebay-korea.tistory.com/88)
...
* [QUARKUS - Supersonic Subatomic Java A Kubernetes Native Java stack tailored for GraalVM & OpenJDK HotSpot, crafted from the best of breed Java libraries and standards](https://quarkus.io/)
  ...
  * [Why Quarkus Should Be Your Next Tech Stack: Faster, Greener & Happier • Holly Cummins • GOTO 2023 - YouTube](https://www.youtube.com/watch?v=0FhQmHb1kLk)
    * [VidiGo Why Quarkus Should Be Your Next Tech Stack: Faster](https://vidigo.ai/share/summary/ff45cde0f2be)
    * [Quarkus가 차세대 기술 스택이 되어야 하는 이유: 더 빠르고, 더 친환경적이고, 더 행복하게 - Holly Cummins - GOTO 2023 | 완벽한 영상요약, 릴리스에이아이 | Lilys AI](https://lilys.ai/digest/522736)
...
* [log4j 2](http://logging.apache.org/log4j/2.x/)
  ...
  * [Log4J vulnerability on the 🔥 ? How to check your application is impacted and fix#devops #devsecops - YouTube](https://www.youtube.com/watch?v=4c46SFh7jt4)
...
* [우아한형제들 JPA 강의 소감과 적용 사례 | 우아한형제들 기술블로그](https://techblog.woowahan.com/2598/)
...
* [MySQL 환경의 스프링부트에 하이버네이트 배치 설정해 보기 | 우아한형제들 기술블로그](https://techblog.woowahan.com/2695/)
...
* [Hibernate 의 ‘불편한’ 편의 기능들. Hibernate 는 지연 로딩, 캐싱, 쿼리 순서 최적화 등 개발자가… | by Hyeon9mak | Nov, 2024 | Monday9pm](https://monday9pm.com/hibernate-%EC%9D%98-%EB%B6%88%ED%8E%B8%ED%95%9C-%ED%8E%B8%EC%9D%98-%EA%B8%B0%EB%8A%A5%EB%93%A4-06a1fbc7492a)
...
* [응? 이게 왜 롤백되는거지? | 우아한형제들 기술블로그](https://techblog.woowahan.com/2606/) isGlobalRollbackOnParticipationFailure
...
* [3월 우아한 Tech 세미나 후기 | 우아한형제들 기술블로그](https://techblog.woowahan.com/2619/) 스프링 리액티브
...
* [Spring 의 Cache 추상화를 사용하면서, 단건/다건 key 에 대한 동일 저장소 사용하기 | 우아한형제들 기술블로그](https://techblog.woowahan.com/2601/)
...
* [추가배포 없이 API의 case 통일시키기 - tech.kakao.com](https://tech.kakao.com/posts/665) DTO
  * [추가 배포 없이 API의 case 통일시키기 / if(kakaoAI)2024 - YouTube](https://www.youtube.com/watch?v=ZE5xgQuvHFQ)
...
* [SpringCamp 2024 - YouTube](https://www.youtube.com/playlist?list=PLdHtZnJh1KdY3gEi7EPa2AuWn5NKRVmDf)
...
* [시의적절한 커스텀 어노테이션 | 우아한형제들 기술블로그](https://techblog.woowahan.com/2684/)
...
## Library Spring AI
* [Spoqa 기술 블로그 | AI를 활용한 주문서 생성 자동화: 카카오톡 주문을 키친보드 주문으로](https://spoqa.github.io/2024/08/19/ai-order-sheet.html)
* [Building Intelligent Applications With Spring AI - YouTube](https://www.youtube.com/watch?v=x6KmUyPWy2Q)
...
* [주소검색서버(woowahan-juso) 개발기(上) | 우아한형제들 기술블로그](https://techblog.woowahan.com/2575/)
* Spring Batch 가이드
...
* [Spring Batch 업데이트 성능 최적화 및 분석 - Yun Blog | 기술 블로그](https://cheese10yun.github.io/spring-batch-update-performance/)
* [Spring Batch Paging Reader 사용시 같은 조건의 데이터를 읽고 수정할때 문제](https://jojoldu.tistory.com/337)
* [파일럿 프로젝트를 통한 배치경험기! | 우아한형제들 기술블로그](https://techblog.woowahan.com/2623/)
...
* [aop를 이용한 oauth2 캐시 적용하기 | 우아한형제들 기술블로그](https://techblog.woowahan.com/2617/)
...
* [Spring Batch와 Querydsl | 우아한형제들 기술블로그](https://techblog.woowahan.com/2662/)
...
* [Spring Boot에서 Repository로 DynamoDB 조작하기 (1) – 설정부터 실행까지 | 우아한형제들 기술블로그](https://techblog.woowahan.com/2633/)
* [Spring Boot에서 Repository로 DynamoDB 조작하기 (2) – Gradle을 활용해 실행 & 테스팅 환경 구축 | 우아한형제들 기술블로그](https://techblog.woowahan.com/2634/)
...
* [멀티 모듈, 그거 왜 쓰는건데? 🤷](https://hudi.blog/why-use-multi-module/)
...
* [테스트에서의 @Transactional 사용에 대해 질문이 있습니다 - Toby vs ChatGPT (2) - YouTube](https://www.youtube.com/watch?v=-961J2c1YsM)
* [깡통 탈출 프로젝트 #1 - MockMvc와 random port](https://velog.io/@hyemin916/%EA%B9%A1%ED%86%B5-%ED%83%88%EC%B6%9C-%ED%94%84%EB%A1%9C%EC%A0%9D%ED%8A%B8-1) @Transactional
...
* [Next-Generation Cloud Native Apps with Spring Boot 3 • Thomas Vitale • GOTO 2023 - YouTube](https://www.youtube.com/watch?v=a5qfg9ybltM)
* [Observability with Spring Boot 3](https://spring.io/blog/2022/10/12/observability-with-spring-boot-3)
* [Baeldung’s tutorial guide to implementing a chatbot with Rag (Langchain and Gemini APIs) | by cowboy76 | Nov, 2024 | Medium](https://medium.com/@ghostflare76/baeldungs-tutorial-guide-to-implementing-a-chatbot-with-rag-langchain-and-gemini-apis-8bd026d19b6c)
* JHipster
...
* [**배달의민족 최전방 시스템! ‘가게노출 시스템’을 소개합니다. | 우아한형제들 기술블로그**](https://techblog.woowahan.com/2667/) Spring WebFlux, 설계, 테스트, 모니터링
...
* [자바 직렬화, 그것이 알고싶다. 실무편 | 우아한형제들 기술블로그](https://techblog.woowahan.com/2551/)
...
* [도메인 특화 언어와 단위 테스트 - 1부 :: Eternity's Chit-Chat](https://eternity-object.tistory.com/34)
* [도메인 특화 언어와 단위 테스트 - 2부 :: Eternity's Chit-Chat](https://eternity-object.tistory.com/35)
* [도메인 특화 언어와 단위 테스트 - 3부 :: Eternity's Chit-Chat](https://eternity-object.tistory.com/36)
...
* DBUnit
  * [스프링부트에서 DbUnit 을 이용하여 DB 테스트해 보기 | 우아한형제들 기술블로그](https://techblog.woowahan.com/2650/)
