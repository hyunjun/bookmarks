...
* [GEOFlow: Open-source GEO content production system with AI tasks, review workflow, and publishing](https://github.com/yaojingang/GEOFlow)
...
* [Advanced Data Structuring with Graphs and Search Trees in Web Scraping Projects | by mostafa jafarzadeh | Nov, 2024 | Medium](https://medium.com/@java.jafarzadeh/advanced-data-structuring-with-graphs-and-search-trees-in-web-scraping-projects-fb6b3f71a38b)
* [A Facebook crawler was making 7M requests per day to my stupid website | Hacker News](https://news.ycombinator.com/item?id=23490367)
...
* [ScrapeGraphAI](https://scrapegraphai.com/)
  * [Scrapegraph-ai: Python scraper based on AI](https://github.com/ScrapeGraphAI/Scrapegraph-ai)
...
* Selenium
  ...
  * [helium: Lighter web automation with Python](https://github.com/mherrmann/helium)
    * [Helium : Python용 경량 웹 자동화 라이브러리 | GeekNews](https://news.hada.io/topic?id=18247)
...
* [skyvern: Automate browser based workflows with AI](https://github.com/Skyvern-AI/skyvern)
  * [AI Browser Automation | Skyvern](https://www.skyvern.com/)
  * [이젠 크롤링 로직도 짤 필요가 없을 것 같네요. "Vision LLM으로 웹사이트를 보고 이해하며 자동 적응"하는 브라우저 자동화 플랫폼, Skyvern이 오픈소스로 공개되었습니다. WebBench 벤치마크 1위(64.4% 정확도)를 기록한 SOTA 성능으로, 한 번도 본 적 없는 웹사이트도 즉시 자동화할 수 있다고 해요. 어느날 갑자기 작동 안 하는… | HaYeJin Kang](https://www.linkedin.com/posts/h4y3j1n_%EC%9D%B4%EC%A0%A0-%ED%81%AC%EB%A1%A4%EB%A7%81-%EB%A1%9C%EC%A7%81%EB%8F%84-%EC%A7%A4-%ED%95%84%EC%9A%94%EA%B0%80-%EC%97%86%EC%9D%84-%EA%B2%83-%EA%B0%99%EB%84%A4%EC%9A%94-vision-llm%EC%9C%BC%EB%A1%9C-activity-7394150697430077440-ucs2)
...
* [The unreasonable effectiveness of HTML — examples](https://thariqs.github.io/html-effectiveness)
  ...
  * AI 에이전트가 생성하는 결과물로서 HTML의 효용. 선형 마크다운 대신 공간 배치·상호작용·슬라이더·토글로 상태 변화 시각화. 탐색·코드 리뷰·디자인 시스템·프로토타이핑에 유리. Claude Code에서 Markdown 대신 HTML 출력으로 표/CSS/SVG/script/JS 상호작용·이미지·캔버스·절대 위치를 활용
  * [Tariq on X: Using Claude Code: the unreasonable effectiveness of HTML](https://x.com/trq212/status/2052809885763747935)
  * [클로드 코드 사용하기: HTML의 놀라운 효율성 | GeekNews](https://news.hada.io/topic?id=29347)
  * [Anthropic 엔지니어가 마크다운 버린 5가지 이유 — Karpathy "이건 AI 진화 법칙" - YouTube](https://www.youtube.com/watch?v=CLI95vLlkxY)
    * AgentOS 채널. Thariq Shihipar(Anthropic Claude Code 팀)와 Karpathy 트윗을 정리한 한국어 해설. HTML 5가지 강점(정보 밀도·시각 명확성·공유·양방향·컨텍스트), AI 출력 진화 단계(텍스트→마크다운→HTML→…), 단점(토큰 4배·git diff 노이즈), 5가지 활용 시나리오
...
* [7 Old-School Practices in HTML Should Be Avoided - DEV Community](https://dev.to/bogdanfromkyiv/7-old-school-practices-in-html-should-be-avoided-3o75)
  * [이제는 피해야 할 낡은 HTML 작성 스타일 7가지 | GeekNews](https://news.hada.io/topic?id=17076)
...
* [</> htmx - high power tools for html](https://htmx.org/)
  ...
  * [PyCon Korea 2025 HTMX로 Django 웹 애플리케이션 개발 생산성 높이기 - 노관옥 - YouTube](https://www.youtube.com/watch?v=cGjb4gyWdGE)
...
* [gomponents: HTML components in pure Go](https://github.com/maragudk/gomponents)
  * [gomponents, HTML components in pure Go](https://www.gomponents.com/)
    * [Gomponents - 순수 Go로 작성된 HTML 컴포넌트 | GeekNews](https://news.hada.io/topic?id=18892)
...
* [HAR Sanitizer](https://har-sanitizer.pages.dev/)
  * [har-sanitizer](https://github.com/cloudflare/har-sanitizer)
...
* [LaunchKit — free template for devtool landing pages](https://launchkit.evilmartians.io/)
  ...
  * [We studied 100 dev tool landing pages—here’s what really works in 2025—Martian Chronicles, Evil Martians’ team blog](https://evilmartians.com/chronicles/we-studied-100-devtool-landing-pages-here-is-what-actually-works-in-2025)
    * [2025년의 개발툴 랜딩 페이지들 분석 | GeekNews](https://news.hada.io/topic?id=22207)
...
* [What is Reverse Proxy ? #devops #devsecops #cloudcomputing - YouTube](https://www.youtube.com/shorts/BA9zPl0kWmk)
...
* [go-proxy: Easy to use reverse proxy with docker integration](https://github.com/yusing/go-proxy)
  * [GoDoxy - 사용하기 쉬운 리버스 프록시 | GeekNews](https://news.hada.io/topic?id=18940)
...
* [PYTHON 내장 라이브러리(wsgiref)로 가짜 FLASK 만들기](https://devocean.sk.com/blog/techBoardDetail.do?ID=164540)
* [I/O Python의 Selectors](https://devocean.sk.com/blog/techBoardDetail.do?ID=165202)
* [네트워크 WSGI와 Python 1편](https://devocean.sk.com/blog/techBoardDetail.do?ID=165282)
...
* [fastapi: FastAPI framework, high performance, easy to learn, fast to code, ready for production](https://github.com/tiangolo/fastapi)
  ...
  * [FastApi - YouTube](https://www.youtube.com/playlist?list=PLEN4AkU3yNudIK-s7ai09F_2ZY2FMf79i)
  * [정말 기초적인 FastAPI 튜토리얼 #0 - 환경 설정](https://blog.raccoony.dev/fastapi-abc-0-configuring-the-environment/)
  ...
  * [SQLModel + FastAPI: Say Goodbye to Repetitive Database Code - YouTube](https://www.youtube.com/watch?v=GONyd0CUrPc)
  ...
  * [fastapi_mcp: Expose your FastAPI endpoints as Model Context Protocol (MCP) tools, with Auth!](https://github.com/tadata-org/fastapi_mcp)
    ...
    * [FastAPI 웹 애플리케이션을 모델 컨텍스트 프로토콜(MCP) 서버로 자동 변환하는 fastapi-mcp 라이브러리 - YouTube](https://www.youtube.com/watch?v=cmlrrSd6L4I)
...
* [panther: Fast & Friendly Python Web Framework](https://github.com/AliRn76/panther)
...
* [Mesop](https://google.github.io/mesop/)
  ...
  * [Mesop - Python-based UI framework from Google! - YouTube](https://www.youtube.com/watch?v=D-cmqg_Wvi4)
    * [VidiGo Mesop - Python-based UI framework from Google!.mp4](https://vidigo.ai/share/summary/44ddcc440357)
    * [Mesop - 구글의 파이썬 기반 UI 프레임워크! | 완벽한 영상요약, 릴리스에이아이 | Lilys AI](https://lilys.ai/digest/773156)
  * [Google's MESOP: Building Beautiful Web UIs in Pure Python - YouTube](https://www.youtube.com/watch?v=IYpsbwJmN7c)
    * [VidiGo Google's MESOP: Building Beautiful Web UIs in Pure](https://vidigo.ai/share/summary/8eb0af6aedf6)
    * [구글의 MESOP: 순수 파이썬으로 아름다운 웹 UI 구축하기 | 완벽한 영상요약, 릴리스에이아이 | Lilys AI](https://lilys.ai/digest/788648)
...
* [Reflex](https://reflex.dev/)
  ...
  * [Reflex (Pynecone) - Part 1(소개: Python기반의 Full Stack Framework)](https://devocean.sk.com/blog/techBoardDetail.do?ID=165094)
  * [PyCon KR 2023 Pynecone 프레임워크로 웹 기반 운영도구 개발하기 임찬식 - YouTube](https://www.youtube.com/watch?v=KcX6N--b9uI)
* [Robyn - An async Python Framework written in Rust](https://robyn.tech/)
  * [robyn: Robyn is a fast and extensible async python web server with a rust runtime](https://github.com/sansyrox/robyn)
  * [Shivay Lamba: Robyn - An asynchronous Python web framework with a Rust runtime | PyData Global 2022 - YouTube](https://www.youtube.com/watch?v=SJVFxVeaY8I)
...
* [Streamlit. The fastest way to build custom ML tools](https://www.streamlit.io/)
  ...
  * [Streamlit을 간단히 사용해보기](https://webnautes.kr/streamliteul-gandanhi-sayonghaebogi/)
...
* [Taipy, an open-source Python library for building your web applications frontend & backend](https://www.taipy.io/)
  ...
  * [Unlocking the Power of What-If Analysis for BI, Data, and AI with Taipy - YouTube](https://www.youtube.com/watch?v=lqBhJATrsiw)
...
* [React reportWebVitals](https://velog.io/@jollypyun/React-reportWebVitals)
...
* [인포그랩 공식 홈페이지 성능 최적화 후기 \:\ 초기 로딩, 렌더링 속도 단축 비결 | InfoGrab, DevOps 전문 기술 기업 | 인포그랩 | GitLab기반 DevSecOps 구축,컨설팅,교육,기술지원 서비스 제공](https://insight.infograb.net/blog/2024/09/11/web-performance/)
...
* [Wasm Components for Every Language - Kyle Brown, SingleStore - YouTube](https://www.youtube.com/watch?v=IqehHuPYUSc)
...
* [Webassembly beyond the browser by Mete Atamel, Google - YouTube](https://www.youtube.com/watch?v=rtbh1wnxr_Q)
...
* [WebAssembly in Production: A Compiler in a Web Page • Brian Carroll • GOTO 2023 - YouTube](https://www.youtube.com/watch?v=BD46Yv7ywvc)
  ...
  * [프로덕션 환경에서의 웹어셈블리: 웹 페이지의 컴파일러 - Brian Carroll - GOTO 2023 | 완벽한 영상요약, 릴리스에이아이 | Lilys AI](https://lilys.ai/digest/441312?sId=BD46Yv7ywvc)
    * 1. 웹어셈블리의 프로덕션에서 컴파일러를 웹페이지에서 사용하기
      * 웹어셈블리는 브라우저에서 실행되는 *이진 코드 형식*, 자바스크립트 외에도 코드를 실행하는 선택지로 사용
      * *Rock*라는 오픈소스 프로젝트의 일부로서 언어 개발자들이 *웹어셈블리로 포팅*하여 *실제 사이트 운영* 및 *정적 사이트 제작*, 이렇게 함으로써 다양한 언어들이 웹어셈블리로 컴파일되고 사용
      * 웹어셈블리를 사용하면 *입문자에게 좋은 대안*, 언어를 확인하고 사용해볼 수 있어 유용, 특히 웹어셈블리는 *정적 사이트*를 만드는 것을 가능하게
      * 여러 *고급 프로그래밍 언어들이* *웹어셈블리로 컴파일되어* 실제 사이트에서 사용되고 있음을 확인 가능
    * 2. 컴파일러 익스플로러 툴과 웹어셈블리를 통한 웹 서비스 아키텍처 비교
    ...
    * 3.️ 컴파일러에서 REPL 만들기: 언어 차이와 도전
      * 컴파일러로부터 REPL을 구축하는 방법은 컴파일된 *언어와 해석된 언어간의 차이*에 달려있음
    ...
    * 4. 컴파일러의 프로덕션 vs. 개발 시나리오: 성능 중심 vs. 수정 및 디버깅 중심
      * 프로덕션 시나리오에서는 최종 *바이너리의 러타임*이 중요, 컴파일 타임은 오래 걸려도 괜찮음
      * 개발 시나리오에서는 *빠른 컴파일*이 필요하여 최적화를 줄이는 경향, *버그 발견 및 수정*에 초점
      * 컴파일러는 이 두 시나리오에 대한 *구조*를 가지며, REPL 사용 사례에는 개발 쪽이 더 유리
      * 페이지 크기를 줄이기 위해 컴파일러의 *대체 진입점*을 만들어, CLI 패키지를 통해 명령줄 옵션을 해석하고 다른 패키지를 통합
    * 5. Web REPL을 위한 웹 어셈블리 최적화
    ...
    * 6. 웹 어셈블리 및 자바스크립트 기능 설명과 그 연결 방법에 대한 설명
    ...
    * 7. 웹어셈블리와 자바스크립트의 상호작용
      * 웹어셈블리는 자바스크립트 엔진의 *즉시 컴파일*을 활용하여 최적화된 형태로 *최적 컴파일*
      * 웹어셈블리는 *자바스크립트 함수*처럼 보이며, 양쪽은 서로 번호 형식의 *인자* 및 *반환 값*을 사용하여 *함수 호출* 수행
      * 자바스크립트는 웹어셈블리의 메모리를 볼 수 있고 *숫자 배열*로 인식하여 읽고 쓸 수 있으나, *웹어셈블리*는 자바스크립트 객체를 볼 수 없음
      * 문자열 전달 예시를 들어, 자바스크립트에서 웹어셈블리로 문자열을 전달할 때 *UTF-8으로 인코딩*하여 *메모리*에 저장, *실제 웹어셈블리 함수*를 호출
    * 8. 웹어셈블리를 통한 문자열 반환과 코드 생성 방법
      * 웹어셈블리는 HTML 페이지를 수정할 수 없기 때문에 JavaScript 측으로 출력 부분을 옮겨야 함
      * 입력 변화에 따른 함수로 *텍스트 처리*하며 내부 HTML에 결과를 표시하는 방식 확인
      * 문자열 반환을 위해 *입력 포인터와 길이*를 활용하여 JavaScript 문자열을 만들고 반환하는 과정 설명
      * 이때 *Wasm Bindgen* 같은 도구를 활용하여 번거로운 과정 대신에 코드를 생성함으로써 작업 용이
    * 9. 웹어셈블리 사용: 사용자 코드 평가와 실행
      * 웹어셈블리로 *사용자 코드 평가*는 인스턴스화와 실행 단계로 구분
      * 우선, '인스턴스화'는 숫자로 이루어진 바이트 배열을 *실행 가능한 웹어셈블리 인스턴스*로 변환하는 작업 의미
      * '인스턴스화' 후에는 *웹어셈블리 인스턴스*가 생성되어 JavaScript에서 호출할 수 있는 웹어셈블리 함수를 포함
      * 이후 JavaScript 어플리케이션은 컴파일러 웹어셈블리를 호출, 사용자 코드를 실행하여 결과 반환. 이는 여러 단계를 거쳐 진행
    * 10. 웹어셈블리를 이용한 아키텍처의 이점과 도구들
      * 터미널 CLI, Repl, 웹 Repl 간에 *공유된 코드*가 있었으며, 이들 간의 *비동기 처리*를 위해 함수 분리
...
* [Wasmer - The Universal WebAssembly Runtime](https://wasmer.io/)
  ...
  * [Wasmer 5.0 릴리즈 | GeekNews](https://news.hada.io/topic?id=17566)
