...
* [react-native-image-modal - react-native-image-modal을 사용해서 이미지를 전체 화면으로 표시해보고, pinch 확대, 축소 등을 사용해 보자](https://deku.posstree.com/ko/react-native/react-native-image-modal/)
