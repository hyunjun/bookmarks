...
* [NB - Welcome to Nullboard](https://nullboard.io/preview)
  * [nullboard: Nullboard is a minimalist kanban board, focused on compactness and readability](https://github.com/apankrat/nullboard)
  * [Nullboard - 단일 HTML 파일로 구현된 칸반 보드 | GeekNews](https://news.hada.io/topic?id=18350)
...
* [someday: Free to host and open-source cal.com / calendly alternative built on Google-Apps-Script for Gmail users. Built with modern technologies like React, TypeScript, Shadcn/UI, and Vite. https://someday-demo.vercel.app ](https://github.com/rbbydotdev/someday)
  * [Someday - Gmail/Google App Script를 이용한 Calendly 대체 | GeekNews](https://news.hada.io/topic?id=17568)
...
* [Tabby - a terminal for a more modern age](https://tabby.sh/)
  ...
  * [터미널이요? iTerm2, MobaXterm도 좋지만 저는 Tabby.sh 씁니다. - YouTube](https://www.youtube.com/live/AEOwU3dl3Jg)
...
* [vagrant로 linux에서 winodws 사용하기](http://blog.naver.com/hancury/220757948510)
  ...
  * [ngrok - ngrok을 사용하여 외부 환경에서 가상 환경(Guest System)에 접근해 보도록 구성해 보겠습니다](https://deku.posstree.com/ko/environment/ngrok/)
...
* [wezterm - Wez's Terminal Emulator](https://wezfurlong.org/wezterm/)
  * [wezterm 사용기](https://velog.io/@qbx2/wezterm-%EC%82%AC%EC%9A%A9%EA%B8%B0)
...
* [Kopia](https://kopia.io/)
  * [Kopia - 빠르고 안전한 오픈소스 백업 소프트웨어 | GeekNews](https://news.hada.io/topic?id=11100)
...
* [GitHub Pages로 웹사이트 무료 호스팅하기 - YouTube](https://www.youtube.com/watch?v=rd1C-LFz8fU)
  * [GitHub Pages로 웹사이트 무료 호스팅하기 | Engineering Blog by Dale Seo](https://www.daleseo.com/github-pages/)
...
* [cafelua.com: AI 기반 커피 챗, 타로, 일기, 방명록을 제공하는 가상 찻집 웹앱](https://github.com/luke-n-alpha/cafelua.com)
  * [카페루아 인프라 - 거의 공짜로 굴리는 법](https://www.cafelua.com/ko/desk/20260306-%EC%B9%B4%ED%8E%98%EB%A3%A8%EC%95%84-%EC%9D%B8%ED%94%84%EB%9D%BC-%EA%B1%B0%EC%9D%98-%EA%B3%B5%EC%A7%9C%EB%A1%9C-%EA%B5%B4%EB%A6%AC%EB%8A%94-%EB%B2%95/)
  * Next.js 16 + Gemini 2.5 Flash. Vercel/Firebase 무료 티어로 도메인 등록비만 월 고정 비용
...
* [Github로 블로그 만들기 + LaTeX 적용하기](https://helloworldpark.github.io/jekyll/update/2016/12/18/Github-and-Latex.html)
  ...
  * [jekyll 설치](https://deku.posstree.com/ko/jekyll/installation/)
  ...
  * [jekyll 폴더 구조](https://deku.posstree.com/ko/jekyll/directory_structure/)
  ...
  * [HITS로 방문자수 표시하기 - HITS를 이용하여 정적 웹 사이트의 방문자 수를 표시해 봅시다.](https://deku.posstree.com/ko/share/hit-counts/)
  * Docsify
...
* [Zen Browser](https://www.zen-browser.app/)
  * [Zen - Firefox 엔진 기반의 Arc와 비슷한 오픈소스 브라우저 | GeekNews](https://news.hada.io/topic?id=16405)
...
* [chrome-devtools-mcp: Chrome DevTools for coding agents](https://github.com/ChromeDevTools/chrome-devtools-mcp)
  ...
  * [안 쓰고 있다면 진짜 이건 손해입니다: Chrome DevTools MCP | duck blog | 기술 블로그](https://duck-blog.vercel.app/blog/web/chrome-devtools-mcp-game-changer)
    * [안 쓰고 있다면 진짜 이건 손해입니다: Chrome DevTools MCP | Kim Deokgoo](https://www.linkedin.com/posts/kim-deokgoo-51b583155_%EC%95%88-%EC%93%B0%EA%B3%A0-%EC%9E%88%EB%8B%A4%EB%A9%B4-%EC%A7%84%EC%A7%9C-%EC%9D%B4%EA%B1%B4-%EC%86%90%ED%95%B4%EC%9E%85%EB%8B%88%EB%8B%A4-chrome-devtools-mcp-activity-7390740765905309697-VQwB)
...
* [SSHBool — A blazing-fast desktop workspace for remote infrastructure](https://ssh.devbool.com/)
  * [sshbool: A blazing-fast desktop workspace that unifies SSH, SFTP, terminal, Docker, databases, and remote server management in one application](https://github.com/omarsenusi/sshbool)
  * 터미널·SFTP·에디터·DB GUI·서버 모니터링을 하나의 키보드 우선 데스크톱 워크스페이스로 통합. "Connect once, do everything" 아키텍처—서버당 멀티플렉스된 SSH 연결 하나를 열고 터미널 세션·파일 전송·에디터 버퍼·DB 쿼리를 같은 연결의 별도 채널로 라우팅해 지연·서버 부하 최소화
  * Tauri v2 + Rust 코어 + React 19, AES-256 암호화. Apache 2.0
...
* [bruno](https://www.usebruno.com/)
  ...
  * [The New Fast and Git-Friendly Opensource API client - YouTube](https://www.youtube.com/watch?v=ICw2xQtFUdc)
* curl
...
* postman
  ...
  * [Introducing the Postman VS Code Extension | Postman Blog](https://blog.postman.com/introducing-the-postman-vs-code-extension/)
  * [Master API Testing with Postman](https://www.freecodecamp.org/news/master-api-testing-with-postman/)
  * [introduction-to-postman-course](https://github.com/vdespa/introduction-to-postman-course)
...
* VS Code, visual studio code
  ...
  * C/C++
    ...
    * [Visual Studio Code를 사용한 C/C++ 개발환경 만들기-(Windows/Ubuntu)](https://webnautes.tistory.com/1854)
  ...
  * Python
    ...
    * [vscode에서 파이썬 개발환경 세팅하기 (가상환경, 개발도구)](https://sjquant.tistory.com/93) pyenv, poetry
  * react
  ...
  * [vscode.dev Visual Studio Code for the Web](https://code.visualstudio.com/blogs/2021/10/20/vscode-dev)
    ...
    * [노트북없이 코딩하는 법 - YouTube](https://www.youtube.com/watch?v=SYcInXWOC40)
...
* Google sheet
  ...
  * [Ah-ha 구글시트에서 카카오톡 발송하기 - 정보 공유 - 한국 노코드 커뮤니티](https://www.nocodekorea.org/t/ah-ha/788)
* Gmail
...
* [리눅스에서 쓸 수 있는 베스트 그래픽 프로그램 정리](https://www.clien.net/service/board/useful/14961441)
  ...
  8. [김프 Gimp](https://www.gimp.org)
    ...
    * [파이썬으로 플러그인 만들기②: image와 drawable 다루기 기초](https://employeecoding.tistory.com/405)
    * [파이썬으로 플러그인 만들기③: 워크플로우 자동화 기초](https://employeecoding.tistory.com/406)
    * [파이썬으로 플러그인 만들기④: 플러그인에 단축키 지정하기](https://employeecoding.tistory.com/407)
    * [파이썬으로 플러그인 만들기⑤: 컬러링북 만들기(최종)](https://employeecoding.tistory.com/408)
...
* [아이폰 사진 8만장 관리! 훨씬 더 쉽고 편한 방법이 있습니다 😲 - YouTube](https://www.youtube.com/watch?v=vXhYcS7f8rQ)
  * [아이폰 사진 8만장 관리! 훨씬 더 쉽고 편한 방법이 있습니다 😲 | 완벽한 영상요약, 릴리스에이아이 | Lilys AI](https://lilys.ai/digest/445309?sId=vXhYcS7f8rQ)
    * 4. 외장 드라이브에 사진 정리 및 신규 생성
    * 5.아이폰 사진앱 활용 팁과 단축키 설정
      * 사진앱의 편의성과 단축키 설정으로 워크플로우 개선
    * 6.️ 윈도우 키워드 관리자의 다양한 기능과 활용 방법
      * 윈도우의 키워드 관리자 기능을 사용하면 사용자 키워드를 추가하고 관리 가능
      * 키워드는 태그로 간주되며, **즐겨찾기**나 **라벨링**하여 효율적으로 분류 가능
      * 알파벳을 이용한 빠른 그룹 추가로 **편리하게 키워드 삽입**이 가능하며, 라이브러리 방식을 통해 키워드 관리
      * 사진 관리 시 키워드 분류와 빠른 삽입이 가능하며, **애플의 라이브러리 방식이** 효율적
      * 이를 통해 **500장 이상의 사진도 효과적**으로 관리 가능
    * 7. 사진 보정 및 편집 기능 비교
    * 8. 이케아 가구에 SSD를 활용한 키워드 관리
      * 라이브러리를 연도 단위로 정리하고 '상위' 키워드를 활용해 옷을 관리
      * 애플 제품으로 키워드 관리를 통해 효과적인 작업 관리 방법을 발견
      * 이를 통해 SSD를 활용한 백업 및 사진 관리하는 방법을 소개
      * 아이클라우드를 사용하지 않는 사람들을 대상으로 키워드 관리와 사진 작업흐름 소개
    * 9. 검색 및 편집 기능 설명
      * 2023년 사진 검색 및 편집 방법 소개
      * 2023년 검색 후 상위 라이브러리 기능을 활용하여 특정 연도로 필터링하여 편집 가능
      * 원하는 사진 선택 후 'cm'클릭으로 크랩을 이용해 편집하며, 편집된 부분은 되돌릴 수 있음
      * 편집에서 '원본 복기'기능을 통해 수정 사항을 초기 상태로 되돌리기 가능
...
* [Atoll — Dynamic Island for macOS](https://altic.dev/fluid)
...
* compress
  ...
  * [PeaZip free archiver utility, open extract RAR TAR ZIP files](https://peazip.github.io/)
    * [Peazip - 오픈소스 파일 압축/해제 유틸리티 | GeekNews](https://news.hada.io/topic?id=15217)
...
* [mouseless: the BEST app for ditching the mouse (full fast control w/ just keyboard, macOS 2024/2025) - YouTube](https://www.youtube.com/watch?v=J0rwQVNQkHM)
...
* [**본격 macOS에 개발 환경 구축하기**](https://subicura.com/2017/11/22/mac-os-development-environment-setup.html)
  ...
  * [How To Make Your Boring Mac Terminal So Much Better - YouTube](https://www.youtube.com/watch?v=CF1tMjvHDRA)
...
* brew
  ...
  * [**Homebrew와 Shell Script를 사용하여 맥(Mac) 개발 환경 구축 자동화하기**](https://deku.posstree.com/ko/environment/configure-development-environment-on-mac-with-homebrew-and-shell-script/)
...
* [Expo Orbit v1: launcher app launched into orbit - Expo Changelog](https://expo.dev/changelog/2023/11-14-orbit-v1)
  * Expo에서 Expo Application Services(EAS)로 빌드 후 스낵 프로젝트를 실행하는 과정을 개선하기 위해 지난 8월 Orbit을 공개했는데 반응이 좋아서 프로젝트를 진행하고 이번에 Orbit v1 공개
  * Orbit을 이용하면 macOS 메뉴바에서 빠르게 빌드하고 실행 가능
* [gcalcli - Get your google calendar into tmux](https://blog.hauck.io/get-your-google-calendar-into-tmux/)
* [Ghostty](https://ghostty.org/)
  * [The BEST Terminal Just Launched - Ghostty 👻 - YouTube](https://www.youtube.com/watch?v=heRfqBEhwr0)
...
* [iTerm2](https://iterm2.com/)
  ...
  * 맥(Mac) 개발 환경 구축
    * [(1) - iTerm과 zsh](https://deku.posstree.com/ko/environment/mac-iterm-zsh/)
    * [(2) - tools](https://deku.posstree.com/ko/environment/mac-development-tools)
    * [(3) - 개발 환경](https://deku.posstree.com/ko/environment/mac-development-environment)
...
* [tea - The Homebrew replacement from the maker of Homebrew | Product Hunt](https://www.producthunt.com/posts/tea)
...
* [ente: Fully open source, End to End Encrypted alternative to Google Photos and Apple Photos](https://github.com/ente-io/ente)
  * [Ente - E2E 암호화 지원하는 구글 포토/애플 i포토 대체제 오픈소스 | GeekNews](https://news.hada.io/topic?id=13640)
...
* [glues: Vim-inspired TUI note-taking app with multi-backend storage — privacy-focused](https://github.com/gluesql/glues)
* [Heptabase](https://heptabase.com/)
  * [Heptabase: Note-Taking & Mind-Mapping in One App! - YouTube](https://www.youtube.com/watch?v=yNEs0uwnqOs)
...
* [Joplin - an open source note taking and to-do application with synchronisation capabilities](https://joplinapp.org/)
  ...
  * [Joplin Notes: Open Source Notes Without Lock-In - YouTube](https://www.youtube.com/watch?v=jyzcDIudczA)
...
* [Xournal++ - Xournal++](https://xournalpp.github.io/) open-source and cross-platform note-taking software
...
* [마크다운의 부상: LLM 시대가 요구하는 문서 포맷 | AIstar](https://haseong.github.io/column/2025/06/28/2204f32e7b6080eeb86ce2966641a2fc.html)
...
* [markitdown: Python tool for converting files and office documents to Markdown](https://github.com/microsoft/markitdown)
  * [Microsoft MarkItDown - 파일 및 오피스 문서를 Markdown으로 변환하 | GeekNews](https://news.hada.io/topic?id=18260)
...
* [mdtable2csv: Convert markdown tables to csv](https://github.com/tomroy/mdtable2csv)
...
* [Obsidian - A second brain, for you, forever](https://obsidian.md/)
  ...
  * [Templater: A template plugin for obsidian](https://github.com/SilentVoid13/Templater?tab=readme-ov-file)
    ...
    * [템플릿을 만들어 옵시디언에서 지식 관리하자, Templater 플러그인 - 북트레싱](https://booktracing.com/%EC%98%B5%EC%8B%9C%EB%94%94%EC%96%B8-%ED%85%9C%ED%94%8C%EB%A6%BF-templater-%ED%94%8C%EB%9F%AC%EA%B7%B8%EC%9D%B8/)
    * [Templater 심화: 명령어 (Commands)](https://kaminik.tistory.com/entry/Templater-%EC%8B%AC%ED%99%94-%EB%AA%85%EB%A0%B9%EC%96%B4-Commands)
...
* [Figma: the collaborative interface design tool.](https://www.figma.com/)
  ...
  * Config 2025
    ...
    * [Figma AI 혁신: 웹사이트 제작과 마케팅의 판을 바꾸다 - DX Talk](https://dxtalk.net/figma-ai-revolution/)
    * [생각한 대로 설명하면 AI가 앱 '뚝딱'…피그마도 '바이브 코딩' AI 기능 도입 < 글로벌 < 월드AI < 기사본문 - AI포스트(AIPOST)](https://www.aipostkorea.com/news/articleView.html?idxno=7776#google_vignette)
...
* [MS에서도 인정한 직장인 필수 무료 프로그램 4가지 (Everything, Monitorian, Snipaste, Zoomit) - YouTube](https://www.youtube.com/watch?v=MX07pCmi0To)
* 복구
...
* putty
  ...
  * [슈퍼푸티SuperPutty 터미널을 생산성 있게 꾸미기 - YouTube](https://www.youtube.com/watch?v=kv87ynbJlmk)
...
* WSL Windows Subsystem for Linux
  ...
  * [Isn't WSL2 just a VM?](https://ssg.dev/isnt-wsl2-just-a-vm/)
    * [WSL2는 단순한 VM이 아닌가요? | GeekNews](https://news.hada.io/topic?id=24765)
