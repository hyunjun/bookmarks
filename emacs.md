...
* [Org-mode 기초부터 시작하기 - 용균](https://edykim.com/ko/post/start-with-orgmode-basics/)
...
* [doomemacs: An Emacs framework for the stubborn martian hacker](https://github.com/doomemacs/doomemacs)
  * [doom emacs 전환 후기](http://ohyecloudy.com/emacsian/2022/09/03/welcome-doom-emacs/)
...
* [helm: Emacs incremental completion and selection narrowing framework](https://github.com/emacs-helm/helm)
...
* [vertico.el - VERTical Interactive COmpletion](https://github.com/minad/vertico)
