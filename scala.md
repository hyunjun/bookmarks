...
* [What Scala does better than Haskell and vice versa - YouTube](https://www.youtube.com/watch?v=K76vrOzU53o)
...
* [Haoyi's Programming Blog](http://www.lihaoyi.com/)
  ...
  * [12 years of the com.lihaoyi Scala Platform](https://www.lihaoyi.com/post/12yearsofthecomlihaoyiScalaPlatform.html)
...
* [10+ Scala Concepts you Need to Know - YouTube](https://www.youtube.com/watch?v=nI57LUpjGrk)
...
* future
  ...
  * [Comparing Approaches to Structured Concurrency by James Ward and Adam Hearn - YouTube](https://www.youtube.com/watch?v=g6dyLhAublQ)
...
* Implicit
  ...
  * [Implicit Parameters, When to Use Them (Or Not)! by Julien Truffaut - YouTube](https://www.youtube.com/watch?v=fwu3lLpgZsg)
...
* scalaz
  ...
  * [ZIO — A type-safe, composable library for asynchronous and concurrent programming for Scala](https://zio.dev)
    ...
    * [Zymposium - ZIO HTTP: RC1 and Beyond - YouTube](https://www.youtube.com/watch?v=N8w3vU7K8ao)
    ...
    * [Zymposium - New ZIO Feature - YouTube](https://www.youtube.com/watch?v=OUEHqBtvWD4)
    ...
    * [The ZIO 2 “mental model” | alvinalexander.com](https://alvinalexander.com/scala/zio-2-mental-model-and-best-practices/)
    ...
    * [Zymposium - ZIO API Design Techniques - YouTube](https://www.youtube.com/watch?v=48fpPffgnMo)
    ...
    * [Zymposium - Reloadable Services with ZIO - YouTube](https://www.youtube.com/watch?v=wwS19ZNTS_k)
    ...
    * [Debugging session #1: zio-logging & quill](https://blog.pierre-ricadat.com/debugging-session-1-zio-logging-quill)
    ...
    * ZIO stream
      ...
      * [Day to day stuff: Scheduling tasks and sharing state with streams](https://day-to-day-stuff.blogspot.com/2024/01/scheduling-tasks-and-sharing-state-with.html)
    ...
    * ZIO test
      ...
      * [Diving into ZIO Test 'Aspects': Streamlining Cross-Cutting Concerns in](https://yadukrishnan.live/diving-into-zio-test-aspects-streamlining-cross-cutting-concerns-in-testing)
      * [Errors happen. Can we get rid of them using ZIO Test? | by Americo Vargas | Jan, 2024 | Medium](https://americovargas.medium.com/errors-happen-can-we-get-rid-of-them-using-zio-test-0f0e62913190)
    ...
    * ZScheduler [ZIO WORLD - ZScheduler by Adam Fraser - YouTube](https://www.youtube.com/watch?v=GaWcmRHS-qI)
* sort
...
* [자바 개발자를 위한 스칼라 - Java 개발자를 위한 Scala 맛보기](https://scalabook.hatemogi.com/)
  * [scala-for-java-developers: 자바 개발자를 위한 스칼라 맛보기 예제](https://github.com/hatemogi/scala-for-java-developers)
...
* [Learn Functional Programming The Fast Way! (PDF)](https://alvinalexander.gumroad.com/l/learnfp)
...
* [scalar-conf.com](http://scalar-conf.com/)
  ...
  * [Łukasz Biały HANDS-ON BESOM: INFRASTRUCTURE-AS-A-CODE WITH SCALA Scalar Conference 2024 - YouTube](https://www.youtube.com/watch?v=8Kh02AgaNoU)
  * [Michał Pawlik HOW SLOW IS YOUR TRAM Scalar Conference 2024 - YouTube](https://www.youtube.com/watch?v=E-gnY0weqsk)
  * [Jakub Kozłowski FORAGING INTO EMBEDDED LANDS - THE PATH TO WRITING PLAYDATE GAMES WITH SCALA Scalar - YouTube](https://www.youtube.com/watch?v=paHZkg8Py1U)
  * [Jacek Kunicki GROWING OXEN: CHANNEL OPERATORS AND RETRIES Scalar Conference 2024 - YouTube](https://www.youtube.com/watch?v=gNHkqLmnduQ)
  * [Nguyen Pham STRUCTURED CONCURRENCY IN DIRECT STYLE WITH GEARS Scalar Conference 2024 - YouTube](https://www.youtube.com/watch?v=zJrMboIzYZI)
  * [Wojciech Mazur IMPLEMENTING MULTITHREADING IN SCALA NATIVE Scalar Conference 2024 - YouTube](https://www.youtube.com/watch?v=PcvFw8mbfN4)
  * [Kamil Kloch TURBOCHARGING WEB SOCKET INTEGRATION FOR TAPIR Scalar Conference 2024 - YouTube](https://www.youtube.com/watch?v=xeQP6wHx020)
  * [David Amancio Gil Mendez DIAMOND ARCHITECTURE: LESSONS LEARNED Scalar Conference 2024 - YouTube](https://www.youtube.com/watch?v=LDuDzjo-0Vw)
  * [Jamie Thompson MIRRORS FOR OPERATIONS, NOT DATA Scalar Conference 2024 - YouTube](https://www.youtube.com/watch?v=zYl117VzSGA)
...
* [ScalaMatsuri 2024 - YouTube](https://www.youtube.com/playlist?list=PL39pyF64-WFJbT8kSXEF8pXjExGkQD0ss)
* ScalaIO Paris 2022
...
* [Scala 3 improvements in Metals (and hopefully, IntelliJ IDEA)](https://www.linkedin.com/pulse/scala-3-improvements-metals-hopefully-intellij-idea-igal-tabachnik-sibxf/)
...
* [caliban - Functional GraphQL backend in Scala https://ghostdogpr.github.io/caliban ](https://github.com/ghostdogpr/caliban)
  ...
  * [GraphQL in Scala: Handling side effects](https://blog.pierre-ricadat.com/graphql-in-scala-handling-side-effects)
  * [GraphQL in Scala: Role-Based Access Control](https://blog.pierre-ricadat.com/graphql-in-scala-role-based-access-control)
  * [graphql-benchmarks: Setup to compare graphql frameworks](https://github.com/tailcallhq/graphql-benchmarks)
...
* [Cats - Lightweight, modular, and extensible library for functional programming](https://typelevel.org/cats/)
  ...
  * [Accumulate errors in Scala with typelevel cats | ScalaJobs.com](https://scalajobs.com/blog/accumulate-errors-in-scala-with-typelevel-cats/)
...
* [com-lihaoyi](https://github.com/com-lihaoyi)
  ...
  * [Haoyi Li - The Making of the com.lihaoyi Ecosystem | Scala Days 2023 Seattle - YouTube](https://www.youtube.com/watch?v=hwg9GPwSH78)
...
* [ethereal: Run Scala applications as daemons](https://github.com/propensive/ethereal)
  * [Ethereal - Soundness.dev](https://soundness.dev/ethereal)
  * [Jon Pretty on X: "Launch Scala, faster than Native" / X](https://x.com/propensive/status/1828402253562011991?s=46&t=-Vn_duYYMh6qBw9qeOrzQw)
...
* [Finagle - A fault tolerant, protocol-agnostic RPC system](https://github.com/twitter/finagle)
  ...
  * [Finagle Tutorial: Twitter's Scala RPC Library - YouTube](https://www.youtube.com/watch?v=EbWuiURnScw)
...
* [fs2 - Compositional, streaming I/O library for Scala https://fs2.io ](https://github.com/functional-streams-for-scala/fs2)
  ...
  * [I/O](https://fs2.io/#/io)
    ...
    * [Streaming Hash Computations](https://github.com/mpilquist/blog-hashing/blob/main/README.md)
  * [FS2 Kafka · Functional Kafka Streams for Scala](https://fd4s.github.io/fs2-kafka/)
    ...
    * [fs2-kafka: hard choices, Pipes and Weaver tests | Anton Kovalevsky](https://antonkw.github.io/scala/fs2-kafka-pt3/)
...
* [gallia-core/README.md at master · galliaproject/gallia-core · GitHub](https://github.com/galliaproject/gallia-core/blob/master/README.md)
  ...
  * [Anthony Cros - Gallia: Practical Data Transformation in Scala | Scala Days 2023 Seattle - YouTube](https://www.youtube.com/watch?v=hl4GiFNCUv8)
...
* [gum: A tool for glamorous shell scripts 🎀](https://github.com/charmbracelet/gum)
  * [Bash Scripting is AWESOME now?! - YouTube](https://www.youtube.com/watch?v=u2UZp--vFog)
...
* [lagom - The opinionated microservices framework for moving away from the monolith](https://www.lagomframework.com/)
  ...
  * [Lagom is approaching end of life: possible migration paths](https://softwaremill.com/lagom-is-approaching-end-of-life-possible-migration-paths/)
...
* [nettlesome: Typesafe representations of network concepts in Scala](https://github.com/propensive/nettlesome/)
  * [Jon Pretty on X: "Make Impossible States Unrepresentable: Network Edition!" / X](https://x.com/propensive/status/1804140556580262057?s=46&t=-Vn_duYYMh6qBw9qeOrzQw)
...
* [scala-native: Your favorite language gets closer to bare metal](https://github.com/scala-native/scala-native)
  ...
  * [scala-and-scala-native · lbialy/1brc](https://github.com/lbialy/1brc/tree/scala-and-scala-native/scala)
...
* [scala-update: Update your Scala dependencies interactively](https://github.com/kitlangton/scala-update)
...
* [How do we optimise Scala build times? by James Thompson - YouTube](https://www.youtube.com/watch?v=EX-6nqPMcbQ)
...
* [skunk: A data access library for Scala + Postgres](https://github.com/tpolecat/skunk)
  ...
  * [The Skunk Scala Library for Database Interaction: A Comprehensive Guide - Rock the JVM Blog](https://blog.rockthejvm.com/skunk-complete-guide/)
...
* [tapir, or Typed API descRiptions](https://tapir.softwaremill.com/)
  * [tapir: Rapid development of self-documenting APIs](https://github.com/softwaremill/tapir/)
...
* Play
  ...
  * [I replaced most of Play3 and it worked! - YouTube](https://www.youtube.com/watch?v=4EUpiCTVM1c)
...
* [Scala 3 `usePipelining` build flag is a game changer. : r/scala](https://www.reddit.com/r/scala/comments/1d0ga7k/scala_3_usepipelining_build_flag_is_a_game_changer/)
...
* [sbt-jmh - "Trust no one, bench everything." - sbt plugin for JMH (Java Microbenchmark Harness)](https://github.com/ktoso/sbt-jmh)
  * [costOfBoxingScala](https://github.com/jarekratajski/costOfBoxingScala)
...
* [In Scala 3, use 4 Spaces for Indentation - Alexandru Nedelcu](https://alexn.org/blog/2023/11/08/in-scala-3-use-4-spaces-for-indentation/)
...
* [Intermediate's guide to derivations in Scala: Magnolia - Dev notes](https://blog.michalp.net/posts/scala/scala-derivations-show/)
...
* [Pursuing Practical Refinement Types by Michael Perucca - YouTube](https://www.youtube.com/watch?v=oYTGXNrMEho)
...
* [larceny: Scala 3 compiler plugin for testing compiler errors](https://github.com/propensive/larceny/)
  * [Jon Pretty on X: "Compiling Bad Code" / X](https://x.com/propensive/status/1805584626565431646?s=46&t=-Vn_duYYMh6qBw9qeOrzQw)
* sbt
  * `sbt ++3.0.0! console`
...
* [Purify Your Tests III: Lean, Mean Testing Machine](https://blog.daniel-beskin.com/2024-05-30-purify-tests-3)
...
* [ScalaTest](http://www.scalatest.org/)
  ...
  * [Effective Test Parameterization with ScalaTest Tables](https://yadukrishnan.live/effective-test-parameterization-with-scalatest-tables)
...
* [Type class constraints in object algebras](https://vectos.net/blog/type-class-constraints-algebra-copy)
...
* [How to Write a Full-Stack Scala 3 Application with the Typelevel Stack - Rock the JVM Blog](https://blog.rockthejvm.com/full-stack-typelevel/)
* [A Sighting of filterA in Typelevel Rite of Passage](https://fpilluminated.com/deck/220)
...
* [Returning the "Current" Type in Scala](http://tpolecat.github.io/2015/04/29/f-bounds.html)
  * [doobie - a pure functional JDBC layer for Scala](https://github.com/tpolecat/doobie)
    ...
    * [Scala service combined with PostgreSQL, Flyway, Doobie, Hikari-CP, Ciris, IO(Cats Effects), Http4s, ZIO-JSON, and Cake Pattern. | by Nicu Ciobanu | May, 2024 | Medium](https://medium.com/@ciobanunicu.boris/scala-service-combined-with-postgresql-flyway-doobie-ciris-io-cats-effects-http4s-e78d75248118)
  * [tut - doc/tutorial generator for scala](https://github.com/tpolecat/tut)
...
* [Type-Level Programming in Scala: A Hardcore Tic-Tac-Toe - YouTube](https://www.youtube.com/watch?v=sqTtZ3BQnRQ)
...
* [Typed `[T]` Musings - Duncan DeVore - YouTube](https://www.youtube.com/watch?v=6zJegSqY9Fo)
...
* [Why use Scala for building backend applications? | Scalac.io](https://scalac.io/blog/why-use-scala/)
...
* [Lean Scala | Language and Code](https://odersky.github.io/blog/2024-04-11-post.html)
...
* [smithy4s-course](https://github.com/kubukoz/smithy4s-course)
  ...
  * [Call AWS on ANY SCALA RUNTIME with Smithy4s - YouTube](https://www.youtube.com/watch?v=SBJNAf-OGQw)
