...
* [perfbook-ko_KR: Korean translation of perfbook("Is Parallel Programming Hard, And, If So, What Can You Do About It?")](https://github.com/sjp38/perfbook-ko_KR?tab=readme-ov-file)
...
* [The AI CUDA Engineer: Agentic CUDA Kernel Discovery, Optimization and Composition](https://sakana.ai/ai-cuda-engineer/)
  * [이강원 - 일본의 sakana.ai에서 발표한 AI CUDA engineer 논문으로 어제 오늘 AI 커뮤니티가... | Facebook](https://www.facebook.com/kangwon.lee.374/posts/pfbid022BE5uUUirGBrAZvQy5xbcF2qHdTD5QgMVrtsT4Mwv5WYhFhY8xVVTd8Kc2pRDmizl)
* [Introduction to CUDA Programming for Python Developers | PySpur - AI Agent Builder](https://www.pyspur.dev/blog/introduction_cuda_programming)
  * [파이썬 개발자를 위한 CUDA 프로그래밍 입문 | GeekNews](https://news.hada.io/topic?id=19366)
...
* [GPU의 메모리 모델과 인터커넥트(Network) 설계 (원문)](https://appleparan.notion.site/gpu-memory-network-2bc0a9b5b5588013b65ce66cb693f0c0)
  * [GPU의 메모리 모델과 인터커넥트(Network) 설계 - RosettaLens 번역](https://rosettalens.com/s/ko/gpu-memory-model-and-interconnect-network-design-1)
