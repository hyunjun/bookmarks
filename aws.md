...
* [AWS IoT 버튼을 활용하여 차임벨 만들기 | 우아한형제들 기술블로그](https://techblog.woowahan.com/2513/)
...
* [AWS KMS를 이용한 암호화 API 구축하기 | 우아한형제들 기술블로그](https://techblog.woowahan.com/2518/)
...
* [Performance Insight 써도 돼요? | 우아한형제들 기술블로그](https://techblog.woowahan.com/2593/)
...
* [로봇 개발 어떻게 해야되죠? (1/2) – AWS RoboMaker 따라하기 (ROS 어플리케이션 개발과 시뮬레이션 편) | 우아한형제들 기술블로그](https://techblog.woowahan.com/2615/)
...
* [How to Configure GitHub Actions OIDC with AWS Easy Tutorial | DevOpsCube](https://devopscube.com/github-actions-oidc-aws/)
  * GitHub Actions에서 AWS 자격 증명을 GitHub Secrets에 저장하지 않고 OIDC + STS로 단기 자격증명 발급받는 방법. IAM 역할 신뢰 정책 구성, "credentials don't exist until needed and expire shortly after"의 zero standing permissions 모델. self-hosted/GitHub-hosted 러너 모두 지원
...
* [AWS의 공인 IPv4 주소 사용량 파악 및 최적화 | AWS 기술 블로그](https://aws.amazon.com/ko/blogs/tech/identify-and-optimize-public-ipv4-address-usage-on-aws/)
...
* [Packer와 Ansible을 이용한 표준 AMI 만들기 | 우아한형제들 기술블로그](https://techblog.woowahan.com/2624/)
...
* [점점 커지는 RDB Table, S3로 귀양 보내고 Athena로 불러오기 - feat. Optimization with Spark Bucketing | 뱅크샐러드](https://blog.banksalad.com/tech/data-optimization-with-bucketing/)
...
* [Amazon Bedrock Titan 이미지 생성기로 Amazon Rekognition 데이터 세트 만들기 | AWS 기술 블로그](https://aws.amazon.com/ko/blogs/tech/use-amazon-bedrock-titan-image-generator-for-the-data-augmentation-to-train-amazon-rekognition-object-detection-models/)
...
* [티오더의 Amazon Bedrock을 활용한 MCP 기반 운영 플랫폼 개발기 | AWS 기술 블로그](https://aws.amazon.com/ko/blogs/tech/torder-mcp-platform-based-on-amazon-bedrock/)
...
* [대한항공의 AI 대전환: Amazon Bedrock 기반 AI 컨택센터 지식 검색 챗봇 구축 사례 - YouTube](https://www.youtube.com/watch?v=7YbZAOKK3gs)
...
* [Amazon Bedrock AgentCore (Preview) - AWS](https://aws.amazon.com/ko/bedrock/agentcore/)
  ...
  * [Amazon Bedrock AgentCore Runtime을 쉽고 빠르게 시작하기 | AWS 기술 블로그](https://aws.amazon.com/ko/blogs/tech/amazon-bedrock-agentcore-runtime-easy-learn-start/)
    * [Host agent or tools with Amazon Bedrock AgentCore Runtime - Amazon Bedrock AgentCore](https://docs.aws.amazon.com/bedrock-agentcore/latest/devguide/agents-tools-runtime.html)
  ...
  * [mcp-tools: It show how to deploy MCP tools using AgentCore](https://github.com/kyopark2014/mcp-tools)
    ...
    * [사내에서 개발해서 사용하는 생성형 AI 애플리케이션에서 custom MCP 서버(stdio)를 생성해서 사내 API를 활용하면, MCP 사용전과 구조적으로 동일하기 때문에 추가적인 보안 우려없이 MCP를 활용](https://www.linkedin.com/posts/kyoungsu-park-9b9a1068_mcp-toolsreadmemd-at-main-kyopark2014-activity-7368759127591800835-jHdu)
      * [mcp-tools/runtime/kb-retriever/mcp_server_retrieve.py at main · kyopark2014/mcp-tools](https://github.com/kyopark2014/mcp-tools/blob/main/runtime/kb-retriever/mcp_server_retrieve.py)
      * [mcp/application/mcp_server_retrieve.py at main · kyopark2014/mcp](https://github.com/kyopark2014/mcp/blob/main/application/mcp_server_retrieve.py)
      * [mcp-tools/README.md at main · kyopark2014/mcp-tools](https://github.com/kyopark2014/mcp-tools/blob/main/README.md#agentcore-gateway)
...
* [Amazon Nova - Explore Amazon Nova foundation models](https://nova.amazon.com/)
  ...
  * [evaluate-llm-on-korean-dataset: Performs benchmarking on two Korean datasets with minimal time and effort](https://github.com/daekeun-ml/evaluate-llm-on-korean-dataset)
    * [한국어 LLM 평가 리포지토리 전면 개편 & Amazon Nova 2.0 Lite의 한국어 성능 분석 (KMMLU) | Daekeun Kim](https://www.linkedin.com/posts/daekeun-kim_github-daekeun-mlevaluate-llm-on-korean-dataset-activity-7403067104221892609-qyTm)
...
* [claude-code-dashboard: Claude Code Enterprise 분석 대시보드](https://github.com/whchoi98/claude-code-dashboard)
  * [Claude-code-dashboard 소개 | Woo Hyung Choi](https://www.linkedin.com/posts/woohyungchoi_claudecode-anthropic-amazonbedrock-ugcPost-7453006852704911360-3MxR)
  * Anthropic Analytics/Admin/Compliance API 통합 대시보드. 참여·생산성·지출·컴플라이언스 11페이지. Bedrock NL 쿼리(스냅샷 분석·자율 SQL 생성). React+Vite/Express+AWS CDK(CloudFront/WAF/ALB/ECS Fargate/Cognito/Athena)
...
* [pipecat: Open Source framework for voice and multimodal conversational AI](https://github.com/pipecat-ai/pipecat)
  * [Overview - Pipecat](https://docs.pipecat.ai/getting-started/overview)
  * [build-intelligent-ai-voice-agents-with-pipecat-and-amazon-bedrock: This repository shows you how to build real-time, voice-enabled AI agents with Pipecat and Amazon Bedrock](https://github.com/aws-samples/build-intelligent-ai-voice-agents-with-pipecat-and-amazon-bedrock)
...
* [Serverless Development on AWS - Kindle](https://read.amazon.com/kp/kshare?id=4tgk4sflsvfvvfddfur2yymojy)
...
* [AWS CodeCommit as CI Tool - Full Tutorial - YouTube](https://www.youtube.com/watch?v=_OrXeOlelGo)
...
* [How AWS DevOps and CI/CD Pipelines Work](https://www.linkedin.com/posts/shabina-devopsengineer_softwareengineering-devops-aws-activity-7252672796680486912-OP0j/)
...
* [cognito와 next-auth를 통합한 커스텀 로그인 페이지 만들기 - by 최지연님 - AWSKRUG 프론트엔드 소모임 240103 - YouTube](https://www.youtube.com/watch?v=1pbB_y72YoU)
...
* [AWS에서 서버(EC2) 패킷 미러링 하기 | 우아한형제들 기술블로그](https://techblog.woowahan.com/2580/)
...
* [Building a Highly Available EC2 Infrastructure with Terraform - DEV Community](https://dev.to/aws-builders/building-a-highly-available-ec2-infrastructure-with-terraform-m36)
...
* [GuideDoc Deploy EKS thru eksctl - v1.22 v0.105.0.pdf](https://www.slideshare.net/JoHoon1/guidedoc-deploy-eks-thru-eksctl-v122v01050pdf)
...
* [AWS EKS and Application Infrastructure Monitoring | by Shivanshu Sharma | AWS in Plain English](https://aws.plainenglish.io/aws-eks-and-infrastructure-monitoring-98d4ce2a26c0)
  * Setting up proper observability on your resources is important
  * Using popular open source tools like Prometheus for metrics collection, Grafana for visualization, and Loki with Promtail for log aggregation offer a solid base for Kubernetes monitoring
  * The setup includes monitoring both internal EKS resources and external endpoints using Blackbox Exporter
...
* [AWS Lake Formation과 Amazon S3 정책을 통한 안전한 액세스를 위한 AWS Glue Data Catalog의 하이브리드 액세스 모드 소개 | AWS 기술 블로그](https://aws.amazon.com/ko/blogs/tech/introducing-hybrid-access-mode-for-aws-glue-data-catalog-to-secure-access-using-aws-lake-formation-and-iam-and-amazon-s3-policies/)
...
* [새로운 작업 관측성 지표를 사용하여 AWS Glue 작업에 대한 모니터링 및 디버깅 강화, 3부: Amazon QuickSight를 사용한 시각화 및 추세 분석 | AWS 기술 블로그](https://aws.amazon.com/ko/blogs/tech/enhance-monitoring-and-debugging-for-aws-glue-jobs-using-new-job-observability-metrics-part-3-visualization-and-trend-analysis-using-amazon-quicksight/)
...
* [AWS Glue Studio 데이터 준비 기능을 활용한 데이터 통합 및 협업하기 | Amazon Web Services 한국 블로그](https://aws.amazon.com/ko/blogs/korea/integrate-your-data-and-collaborate-using-data-preparation-in-aws-glue-studio/)
...
* [AWS Step Functions에서 외부 엔드포인트 및 작업 상태 테스트 가능 | Amazon Web Services 한국 블로그](https://aws.amazon.com/ko/blogs/korea/external-endpoints-and-testing-of-task-states-now-available-in-aws-step-functions/)
* [AWS Step Functions with Node.js: Build an API | AppSignal Blog](https://blog.appsignal.com/2023/10/18/aws-step-functions-with-nodejs-build-an-api.html)
...
* [AWS re:Invent 2021 - Inside a working serverless SaaS reference solution - YouTube](https://www.youtube.com/watch?v=8Z5zBsKgTxY)
...
* [AWS Global Accelerator](https://velog.io/@repush/AWS-Global-Accelerator)
...
* [Solving Cold Starts for AWS Lambda with Autonomous Concurrency - YouTube](https://www.youtube.com/watch?v=SqeJiWjsjdM)
...
* [(05/27) AWS 람다의 내부 동작 방식 - YouTube](https://www.youtube.com/watch?v=rPQghvkPu-o)
  * [VidiGo (05/27) AWS 람다의 내부 동작 방식.mp4](https://vidigo.ai/share/summary/b478c6167ea1)
  * [(05\27) AWS 람다의 내부 동작 방식 | 완벽한 영상요약, 릴리스에이아이 | Lilys AI](https://lilys.ai/digest/748570)
* [Expert Talk: Are We Post-Serverless? • Julian Wood & James Beswick - YouTube](https://www.youtube.com/watch?v=c9A-lMVVN9E)
  * [VidiGo Expert Talk: Are We Post-Serverless? • Julian Wood](https://vidigo.ai/share/summary/01d4a62b7a40)
  * [전문가 대담: 포스트 서버리스인가? - 줄리안 우드 & 제임스 베스윅 | 완벽한 영상요약, 릴리스에이아이 | Lilys AI](https://lilys.ai/digest/783995)
* [서버리스하게 치지직 방송 알림 봇 만들기. 오늘은 AWS Lambda로만 모든 컴퓨팅을 처리하면서 치지직 방송… | by Junah | Jun, 2024 | Medium](https://junah201.medium.com/%EC%84%9C%EB%B2%84%EB%A6%AC%EC%8A%A4%ED%95%98%EA%B2%8C-%EC%B9%98%EC%A7%80%EC%A7%81-%EB%B0%A9%EC%86%A1-%EC%95%8C%EB%A6%BC-%EB%B4%87-%EB%A7%8C%EB%93%A4%EA%B8%B0-fcb8ad17ccbd)
...
* [AWS CLI v2 - now generally available](https://aws.amazon.com/ko/blogs/developer/aws-cli-v2-is-now-generally-available/)
  ...
  * [AWS CLI AWS Configure 여러 계정 사용하기](https://wooono.tistory.com/294)
  * [AWS CLI 사용하여 S3 파일 삭제하기. To delete a S3 file using the AWS CLI | by Justin | Medium](https://medium.com/@sinkashot/aws-cli-%EC%82%AC%EC%9A%A9%ED%95%98%EC%97%AC-s3-%ED%8C%8C%EC%9D%BC-%EC%82%AD%EC%A0%9C%ED%95%98%EA%B8%B0-e62029429168)
  * [AWS S3 경로 내 용량 또는 파일 개수 확인](https://passwd.tistory.com/entry/AWS-S3-%EA%B2%BD%EB%A1%9C-%EB%82%B4-%EC%9A%A9%EB%9F%89-%EB%98%90%EB%8A%94-%ED%8C%8C%EC%9D%BC-%EA%B0%9C%EC%88%98-%ED%99%95%EC%9D%B8)
  * [Retrieve the most recently modified item using S3 CLI - Amazon web services](https://copyprogramming.com/howto/get-last-modified-object-from-s3-cli)
...
* [awscurl: curl-like access to AWS resources with AWS Signature Version 4 request signing](https://github.com/okigan/awscurl)
...
* [mcp/src/aws-api-mcp-server at main · awslabs/mcp · GitHub](https://github.com/awslabs/mcp/tree/main/src/aws-api-mcp-server)
  * [AWS API MCP Server v1.0.0 release - AWS](https://aws.amazon.com/ko/about-aws/whats-new/2025/10/aws-api-mcp-server-v1-0-0-release/)
    * [AWS API MCP Server v1.0.0 release - AWS | Woo Hyung Choi](https://www.linkedin.com/posts/woohyungchoi_aws-api-mcp-server-v100-release-aws-activity-7379283062813093888-rtm5)
...
* [Amazon SageMaker Studio 신규 콘솔 디자인 변경 | Amazon Web Services 한국 블로그](https://aws.amazon.com/ko/blogs/korea/new-redesigned-ui-for-amazon-sagemaker-studio/)
...
* [Amazon SageMaker JumpStart를 사용하여 텍스트-이미지로 변환하는 Stable Diffusion 모델을 파인 튜닝 하기 | AWS 기술 블로그](https://aws.amazon.com/ko/blogs/tech/finetune-text2image-amazon-sagemaker-jumpstart-stable-diffusion/)
...
* [SageMaker JumpStart와 Vector Store를 이용하여 Llama 2로 Chatbot 만들기 | AWS 기술 블로그](https://aws.amazon.com/ko/blogs/tech/sagemaker-jumpstart-vector-store-llama2-chatbot/)
...
* [Delivering Millions of Notifications within Seconds During the Super Bowl - YouTube](https://www.youtube.com/watch?v=J_sGZnAJhbw)
  * [VidiGo Delivering Millions of Notifications within Second](https://vidigo.ai/share/summary/0a94a5e6db02)
  * [슈퍼볼 경기 중 수초 내에 수백만 건의 알림 전송 | 완벽한 영상요약, 릴리스에이아이 | Lilys AI](https://lilys.ai/digest/1132629)
...
* [AWS DMS를 사용하여 PostgreSQL의 파티션 테이블 데이터를 마이그레이션하기 | AWS 기술 블로그](https://aws.amazon.com/ko/blogs/tech/dms-postgresql-partition-migration/)
...
* [Automate S3 Storage class lifecycle using Terraform | by jaffar shaik | Oct, 2022 | Medium](https://jaffarshaik.medium.com/automate-s3-storage-class-lifecycle-using-terraform-88943db72bee)
  * [practice - Delete bucket objects after specific days](https://www.notion.so/1003/S3-275a48999f494d669cf93806de8d4e3d?pvs=25#1f6bbd07264040bdb132a396beefb3a2)
...
* [AWS S3 Lifecycle configuration 뽀개기 | by HanByul Lee | Mar, 2024 | Medium](https://medium.com/@starrybleu/aws-s3-lifecycle-configuration-%EB%BD%80%EA%B0%9C%EA%B8%B0-d7cd11966d05)
...
* [How Not to Partition Data in S3 (And What to Do Instead)](https://luminousmen.substack.com/p/how-not-to-partition-data-in-s3-and)
  * [⚠️ 혹시 S3에 ‘연/월/일’로 나누어 저장하고 있나요? 파티셔닝 방식의 함정! "데이터를 연, 월, 일로 나눠 저장하면 깔끔하지 않을까?" 처음 데이터 레이크를 설계할 때 누구나 한 번쯤 이런 생각을 하죠. 하지만 이 구조, 그렇게 효율적이지 않은 방식이라는거 알고 계셨나요? 이번 글에서는 많은 팀이 무심코 사용하는 잘못된 파티셔닝 구조와… | Hyunsoo (Ryan) Lee | 댓글 11](https://www.linkedin.com/posts/hyunsoo-ryan-lee_%ED%98%B9%EC%8B%9C-s3%EC%97%90-%EC%97%B0%EC%9B%94%EC%9D%BC%EB%A1%9C-%EB%82%98%EB%88%84%EC%96%B4-%EC%A0%80%EC%9E%A5%ED%95%98%EA%B3%A0-%EC%9E%88%EB%82%98%EC%9A%94-%ED%8C%8C%ED%8B%B0%EC%85%94%EB%8B%9D-%EB%B0%A9%EC%8B%9D%EC%9D%98-activity-7382318323545468928-vM1Q)
  * [DATA S3에서 데이터 파티션 하는 법의 진실… | Charsyam's Blog](https://charsyam.wordpress.com/2025/10/08/data-s3%ec%97%90%ec%84%9c-%eb%8d%b0%ec%9d%b4%ed%84%b0-%ed%8c%8c%ed%8b%b0%ec%85%98-%ed%95%98%eb%8a%94-%eb%b2%95%ec%9d%98-%ec%a7%84%ec%8b%a4/)
...
* [AWS에서 네트워크 공격 자동차단 하기 | 우아한형제들 기술블로그](https://techblog.woowahan.com/2558/)
* [AWS Security Group 중첩 이슈 및 정리 팁](http://ohgyun.com/779)
* [AWS 멀티 계정 환경에서 취약한 Security Group 설정 모니터링 | 우아한형제들 기술블로그](https://techblog.woowahan.com/2665/)
...
* [MiniStack — Free Open-Source Local AWS Emulator](https://ministack.org/)
  * [ministack: Free, open-source local AWS emulator - 60+ services, Terraform compatible, real databases](https://github.com/ministackorg/ministack)
  ...
  * 이후 60개+ AWS 서비스로 확대(단일 포트), 멀티 어카운트·멀티 리전, Terraform 호환. Python 3.12, MIT, 4.2k stars
...
* [Amazon VPC Lattice 정식 출시 – 서비스 간 연결, 보안 및 모니터링 간소화 | Amazon Web Services 한국 블로그](https://aws.amazon.com/ko/blogs/korea/simplify-service-to-service-connectivity-security-and-monitoring-with-amazon-vpc-lattice-now-generally-available/)
* [Amazon VPC Lattice - Part 1](https://zigispace.net/1225)
* [Amazon VPC Lattice - Part 2 : Service Network 공유/타 계정 Service 등록](https://zigispace.net/1226)
* [Amazon VPC Lattice - Part 3 : Service/VPC association,Service Sharing](https://zigispace.net/1227)
* [Amazon VPC Lattice - Part 4 : Custom domain, SSL/TLS Certificate](https://zigispace.net/1228)
* [Amazon VPC Lattice - Part 5 : Service Network/Service Access 정책](https://zigispace.net/1229)
* [Amazon VPC Lattice - Part 6 : Monitoring/Access Logs](https://zigispace.net/1230)
