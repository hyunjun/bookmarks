...
* [수백만 동시 접속을 처리하는 예매 시스템 아키텍처 설계 - YouTube](https://www.youtube.com/watch?v=c-ERjEodn_o) sorted set
  ...
  * [풀영상 수백만 동시접속을 처리하는 선착순 예매 시스템 아키텍처 설계 (총 1시간 3분) - YouTube](https://www.youtube.com/watch?v=EC2Xqyq6vg4)
    * 코딩하는기술사. 2026 초 예매 시스템 아키텍처 영상 5개 합본. 아키텍처 설계, 쏟아진 질문 답변, 대기열에 Kafka 아닌 Redis를 쓰는 이유, 대기열 통신 방법(폴링), 폴링 횟수 vs 웹소켓 유불리
