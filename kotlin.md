...
* [Understanding Strong and Weak References in Kotlin | Medium](https://medium.com/@mahmoudelfoulyyy/understanding-strong-and-weak-references-in-kotlin-c28b164b2d7e)
...
* [Kotlin Contracts: Empowering Your Code for Better Quality | by Arsham Jafari | Sep, 2023 | Medium](https://medium.com/@arshamjafari85/kotlin-contracts-empowering-your-code-for-better-quality-38c26da7d6e6)
...
* [Kotlin Mutex Explained | Medium](https://medium.com/@michalankiersztajn/kotlin-mutex-explained-d2b72281cc42)
...
* [What's new in Kotlin 2.0.0 | Kotlin Documentation](https://kotlinlang.org/docs/whatsnew20.html#kotlin-multiplatform-improvements)
  ...
  * [Kotlin 2.0.0 주요 변경사항 | GeekNews](https://news.hada.io/topic?id=14958)
* [Recap: Kotlin Language Features in 2.0 and Beyond (Michail Zarečenskij) - Speaker Deck](https://speakerdeck.com/dalinaum/recap-kotlin-language-features-in-2-dot-0-and-beyond-michail-zarecenskij)
...
* [Kotlin 객체 생성의 안전성과 유효성 강화하기 - Yun Blog | 기술 블로그](https://cheese10yun.github.io/kotlin-pattern-2/)
...
* [대수적 타입과 코틀린 sealed class](https://www.roach-dev.com/math/algebraic_data_type/)
* [Kotlin — Sealed classes vs Sealed interface | by Armando Picón | Mar, 2024 | Medium](https://devpicon.medium.com/kotlin-sealed-classes-vs-sealed-interface-68681f577b06)
* [Pluu Dev - 요약 What's new in Kotlin for Android (Google I/O '23)](https://pluu.github.io/blog/android/io22/2023/05/24/io23-What%27s_new_in_Kotlin_for_Android/)
...
* Exception
  ...
  * [코루틴 예외 처리 (Exception Handling)](https://brunch.co.kr/@mystoryg/223)
* use
...
* [You Can Do Better With Kotlin • Svetlana Isakova • YOW! 2017 - YouTube](https://www.youtube.com/watch?v=gT5grDVI5IY)
  * [VidiGo You Can Do Better With Kotlin • Svetlana Isakova •](https://vidigo.ai/share/summary/c4e7575c3620)
  * [Kotlin으로 더 잘할 수 있는 방법 - 스베틀라나 이사코바 - YOW! 2017 | 완벽한 영상요약, 릴리스에이아이 | Lilys AI](https://lilys.ai/digest/595271)
...
* [**왜 코루틴을 사용해야 할까?**](https://github.com/tmdgusya/kotlin-coroutine-series/blob/main/chapter/WHY_USE_COROUTINE.md)
  * [kotlin-coroutine-series/CANCELLATION_AND_EXCEPTION_HANDLING.md at main · tmdgusya/kotlin-coroutine-series](https://github.com/tmdgusya/kotlin-coroutine-series/blob/main/chapter/CANCELLATION_AND_EXCEPTION_HANDLING.md)
...
* [Kotlin Flow: Simple yet Powerful Implementation | by Aniket Bhoite | ProAndroidDev](https://proandroiddev.com/kotlin-flow-simple-yet-powerful-implementation-c585f337161a)
...
* [Managing Backpressure in Kotlin Flow: Preventing Overloading Downstream Consumers | by Rizwanul Haque | Stackademic](https://blog.stackademic.com/managing-backpressure-in-kotlin-flow-preventing-overloading-downstream-consumers-c878100c0f81)
* [Kotlin 코루틴으로 성능 개선 - Flow를 활용한 다중 요청 처리 - Yun Blog | 기술 블로그](https://cheese10yun.github.io/kotlin-flow/)
* [Kotlin Flows - The Ultimate Guide - Rock the JVM Blog](https://blog.rockthejvm.com/kotlin-flows/)
...
* [Stop using Dispatchers.IO. Why withContext(Dispatchers.IO) is… | by Vasiliy Nikitin | MobilePeople | Apr, 2025 | Medium](https://medium.com/mobilepeople/stop-using-dispatchers-io-737163e69b05)
...
* [kotlin-magazine: fun code() – A magazine for Kotlin™ developers](https://github.com/kotlin-magazine/kotlin-magazine)
* [Kotlin NoteBook In Intellij](https://devroach.tistory.com/176)
  * [kotlin-notebook-example](https://github.com/tmdgusya/kotlin-notebook-example)
* [kotlinx-atomicfu: The idiomatic way to use atomic operations in Kotlin](https://github.com/Kotlin/kotlinx-atomicfu)
...
* [fixture-monkey: Let Fixture Monkey generate test instances including edge cases automatically](https://github.com/naver/fixture-monkey)
  ...
  * [스프링캠프 2024 Track 1 3.왜 나는 테스트를 작성하기 싫을까? (조성아) - YouTube](https://www.youtube.com/watch?v=pCE7ibRCZEI)
...
* [코틀린 완벽가이드 - YouTube](https://www.youtube.com/playlist?list=PLBNdLLaRx_rKuO_5FIprl0Q5Z4wMqz17f)
...
* [The Big Kotlin Tutorial - Rock the JVM Blog](https://blog.rockthejvm.com/big-kotlin-tutorial/)
