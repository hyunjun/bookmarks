...
* [argo - Get stuff done with Kubernetes Open source Kubernetes native workflows, events, CI and CD](https://argoproj.github.io/)
  ...
  * [Argo CD - Declarative GitOps CD for Kubernetes](https://argo-cd.readthedocs.io/)
    ...
    * [ArgoCD — A Complete Series | DevOps VN](https://devopsvn.tech/argocd-series/)
      * [devops-vn-blog: DevOps VN is a website that shares knowledge about DevOps and Cloud Computing](https://github.com/VersusControl/devops-vn-blog)
      * Kubernetes GitOps CD를 Argo CD로 단계별 학습하는 11장 시리즈. Getting Started→Core Concepts→Private Repo→Architecture→Helm→Kustomize→Resource Hooks→GitOps Secret 관리→ApplicationSet→Multi-Cluster 배포→Keycloak SSO. Book Info 마이크로서비스 앱 배포 실습
...
* [KubeVirt - Virtual Machine Management on Kubernetes](https://kubevirt.io/)
  * [What is KubeVirt and why it's growing - The New Stack](https://thenewstack.io/kubevirt-live-migration-mayastor/)
    * NFS 대신 Mayastor 블록 스토리지로 KubeVirt 라이브 마이그레이션 성능 향상
...
* [narwhal: Vagrant-based Kubernetes Internal Developer Platform (IDP)](https://github.com/dasomel/narwhal)
  * [narwhal-portal: Narwhal IDP management portal (Next.js 16 + React 19)](https://github.com/dasomel/narwhal-portal)
  * [narwhal-portal 공유 | 기하 이](https://www.linkedin.com/posts/%EA%B8%B0%ED%95%98-%EC%9D%B4-ba909924_github-dasomelnarwhal-portal-narwhal-share-7485735688953323520-6WcW/)
  * Vagrant 기반 Kubernetes 내부 개발자 플랫폼(IDP)과 그 관리 포털(Next.js 16+React 19)
...
* [Rancher - Complete container management platform Deploy and manage Kubernetes with ease](https://rancher.com/)
  ...
  * [RKE2 - Rancher's Next Generation Kubernetes Distribution](https://docs.rke2.io/)
    ...
    * [Kubernetes 위에서 운영을 배운 2년 - 기술 선택에서 실제 운영까지의 경험담](https://1ocate.tistory.com/16)
      * 온프레미스에 Kubernetes·Ceph·Jenkins/Argo CD를 구축하고 AWS로 마이그레이션한 2년. 기술 도입 자체보다 예상치 못한 문제와 그때의 판단이 더 중요했고, 인프라와 애플리케이션을 함께 보며 AI와 협력하는 방식으로 진화했다는 회고
...
* [Proxmox 설치 및 환경 설정](https://velog.io/@hong-brother/Proxmox)
  ...
  * [OSX-PROXMOX: Run macOS on ANY Computer (AMD & Intel)](https://github.com/luchina-gabriel/OSX-PROXMOX)
    * Proxmox VE(7.x~8.x)에서 macOS(High Sierra~Sequoia) 가상머신을 설치하는 스크립트. AMD/Intel 하드웨어 지원, Proxmox 셸에서 원커맨드 설치
