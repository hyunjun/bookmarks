...
* [Git 커밋 메시지 실수? 당황하지 말고 이렇게 해결하세요! - YouTube](https://www.youtube.com/shorts/PMyWv_tR-vs)
* `add`
...
* `branch`
  ...
  * [DORA | DevOps Capabilities: Trunk-based Development](https://dora.dev/capabilities/trunk-based-development/)
...
* `commit`
  ...
  * [lumen: Instant AI Git Commit message, Git changes summary from the CLI (no API key required)](https://github.com/jnsahaj/lumen)
    * [이상선 - Lumen — Git 워크플로우 AI 자동화 CLI Lumen은 Git 워크플로우를 AI로 최적화해주는... | Facebook](https://www.facebook.com/100001916096643/posts/31606581362322322/)
* `config`
  * basics
  ...
  * [Jun - ERROR: Repository not found. (git repository가 remote repository와 정상 연결되지 않는 경우)](https://hyunjun.github.io/skunk-html/error-repository-not-found-git-repository%EA%B0%80-remote-repository%EC%99%80-%EC%A0%95%EC%83%81-%EC%97%B0%EA%B2%B0%EB%90%98%EC%A7%80-%EC%95%8A%EB%8A%94-%EA%B2%BD%EC%9A%B0.html)
...
* hook
  ...
  * [훅으로 Git에 훅 들어가기 | 우아한형제들 기술블로그](https://techblog.woowahan.com/2530/)
  * [SwiftLint와 Git Hook을 이용해서 코딩 스타일 관리하기 | 우아한형제들 기술블로그](https://techblog.woowahan.com/2641/)
...
* reset
  ...
  * [Git Reset: Delete Commit in Soft, Mixed, or the Hard Way | CodersTea](https://www.coderstea.com/post/other/git-reset-delete-commit-the-soft-mixed-or-the-hard-way/)
  * [특정 시점 이전으로 코드를 되돌리는 작업 #git #rollback - YouTube](https://www.youtube.com/watch?v=C_KMH2IF_Kc)
...
* [UNIVERSE - Two full days on how to build, collaborate, and deploy great software presented by GitHub](http://githubuniverse.com/)
  * [GitHub Universe 2023 참석기 #1 :: Outsider's Dev Story](https://blog.outsider.ne.kr/1695)
  * [GitHub Universe 2023 참석기 #2 :: Outsider's Dev Story](https://blog.outsider.ne.kr/1696)
...
* [Deploying microservices: the path from laptop to production](https://microservices.io/post/deployment/2024/02/12/deploy-microservices-path-from-laptop-to-production.html)
* [통합된 개발과 배포 : Monorepo와 GitOps의 매력적인 조합](https://saramin.github.io/2024-04-08-monorepo-gitops/)
* [GitOps 구조는 어떻게 진화해왔을까 – 멀티리전 배포를 가능하게 만든 선택들](https://blog.gangnamunni.com/post/gitops-evolution-with-multi-region)
...
* GitHub Pages
  ...
  * [개발자의 DIY: Github Pages로 나만의 모바일 초대장 제작하기](https://ebay-korea.tistory.com/95)
  * [Host your Database for Free on Github Pages - YouTube](https://www.youtube.com/watch?v=cYP0k_shdWc)
...
* [git-it-electron: :computer: Git-it is a (Mac, Win, Linux) Desktop App for Learning Git and GitHub](https://github.com/jlord/git-it-electron)
  * [Git-it-electron 한글화 버전](https://github.com/nallwhy/git-it-electron)
  * [이상선 - 밤에 보기 좋은 꿀팁: Git을 게임처럼 배우기 앱 특징: Mac / Windows / Linux 지원... | Facebook](https://www.facebook.com/lsszz1/posts/pfbid0YuKRRPe7TQiTESx3iK1FGKUasghRQbhcAuAiVeFGR8zsLeFEXNGSesFpbeiADHUBl)
...
* [GitLab](https://www.gitlab.com/)
  ...
  * [Gitlab CI/CD With Docker And Kubernetes For Microservices | Full Episode - YouTube](https://www.youtube.com/watch?v=FDXbkijB0pY)
  * [GitLab 차세대 ‘CI/CD 컴포넌트’ 알아보기 | InfoGrab, DevOps 전문 기술 기업 | 인포그랩 | GitLab기반 DevSecOps 구축,컨설팅,교육,기술지원 서비스 제공](https://insight.infograb.net/blog/2024/05/08/cicd-component/)
  * [Git스러운 협업 체인 만들기](https://brunch.co.kr/@graypool/422)
  * [깃허브 vs. 깃랩, 무엇을 써야할까 - ZDNet korea](https://zdnet.co.kr/view/?no=20220804135812)
  * [Build a Node JS Project Using Docker in Gitlab | by S3CloudHub | Aug, 2022 | Medium](https://s3cloudhub.medium.com/build-a-node-js-project-using-docker-in-gitlab-9fbf55053e0e)
  ...
  * [DevOps GitLab 버전 업그레이드는 계속 된다. | by 루카스Lucas(이상배) / DevOps팀 | Sep, 2024 | 여기어때 기술블로그](https://techblog.gccompany.co.kr/devops-gitlab-%EB%B2%84%EC%A0%84-%EC%97%85%EA%B7%B8%EB%A0%88%EC%9D%B4%EB%93%9C%EB%8A%94-%EA%B3%84%EC%86%8D-%EB%90%9C%EB%8B%A4-e4198b232e6f)
* [Gitleaks - Find secrets with Gitleaks](https://gitleaks.io/)
  * [gitleaks: Find secrets in your code](https://github.com/gitleaks/gitleaks)
  * Git 저장소·파일·stdin에서 비밀번호/API 키/토큰 탐지. regex+엔트로피, TOML 규칙, GitHub Action/pre-commit hook/Docker/CLI. JSON/CSV/JUnit/SARIF 리포트, base64/hex 재귀 디코딩, baseline 비교
...
* [Jujutsu docs](https://jj-vcs.github.io/jj/)
  ...
  * [JJ With Git is My New Favorite Workflow - YouTube](https://www.youtube.com/watch?v=ou4ZNRFXkO0)
