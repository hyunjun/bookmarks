...
* GIL Global Interpreter Lock
  ...
  * [Condition을 사용하여 스레드가 번갈아 가며 실행하는 Python 예제 코드](https://webnautes.tistory.com/2426)
...
* [Jakub Zikl - Right-Sized Scaling: Python APIs at Billions of Requests Without the Complexity - YouTube](https://www.youtube.com/watch?v=slC4nThmIZQ)
  * [야쿠브 지클: 복잡성 없이 수십억 규모의 Python API 확장](https://livewiki.com/ko/content/jakub-zikl-python-apis-scaling)
...
* [argparse](https://docs.python.org/3/library/argparse.html)
  ...
  * [Subcommands with Lazy Imports](https://snarky.ca/subcommands-with-lazy-imports/)
...
* class
  ...
  * [super의 의미(Duet 다중상속), 안원석 - PyCon Korea 2022 - YouTube](https://www.youtube.com/watch?v=Gg99y1o5THM)
...
* dataclass
  ...
  * [모르면 손해? 파이썬 dataclass 5분 설명! - YouTube](https://www.youtube.com/watch?v=VY7akCnhQ9o)
* datetime
...
* [multiprocessing](https://pymotw.com/3/multiprocessing/) multithreading [threading](https://pymotw.com/3/threading) parallel
  ...
  * [PyCon KR 2023 파이썬에서의 병렬 처리 김현우 - YouTube](https://www.youtube.com/watch?v=P5KJT2A-5Qw)
  ...
  * threading
    ...
    * [Python Thread / Process 강제로 종료시키기](https://webnautes.tistory.com/2295)
  * [mpire: A Python package for easy multiprocessing, but faster than multiprocessing](https://github.com/sybrenjansen/mpire)
* namedtuple
...
* profile
  ...
  * [pyftrace: Python function tracer](https://github.com/kangtegong/pyftrace) lightweight Python function tracing tool designed to monitor and report on function calls within Python scripts
...
* string
  ...
  * [7. Input and Output — Python 3.13.3 documentation](https://docs.python.org/3/tutorial/inputoutput.html#formatted-string-literals)
  ...
  * [PEP 750 – Template Strings | peps.python.org](https://peps.python.org/pep-0750/)
    * [Python's new t-strings | Dave Peck](https://davepeck.org/2025/04/11/pythons-new-t-strings/)
      * [Python의 새로운 `t-strings` | GeekNews](https://news.hada.io/topic?id=20463)
...
* [Why Your Async Code Might Be Slower and How to Fix It — Aastha (PyBay 2025) - YouTube](https://www.youtube.com/watch?v=wGDOwNW6lVk)
  * [Why Your Async Code Might Be Slower and How to Fix It — Aastha (PyBay 2025) - SecondB Summary](https://secondb.ai/summary/7914/)
    * [Async 코드 속도 저하 원인 및 해결 | GeekNews](https://news.hada.io/topic?id=24392)
  * [비동기 Python 코드 성능 저하의 원인과 최적화 방법 (PyBay 2025)](https://livewiki.com/ko/content/async-code-slow-fix)
* youtube
...
* [temporalio/sdk-python: Temporal Python SDK](https://github.com/temporalio/sdk-python) 단순히 AsyncIO는 아니고 code replay가 가능(?!)
  * [**Temporal Python – A Durable, Distributed Asyncio Event Loop — Maxim Fateev - YouTube**](https://www.youtube.com/watch?v=jxqPWS_LRzw)
...
* [music21: a Toolkit for Computer-Aided Musicology](https://web.mit.edu/music21/)
  ...
  * [코딩만으로 작곡을 한다고요?(코작한) - YouTube](https://www.youtube.com/playlist?list=PLcmqYelFR_8TGJUngQInVWoweQsRE2Tv6)
...
* [Tiny Python Projects](https://tinypythonprojects.com/)
  * [Ken Youens-Clark - YouTube](https://www.youtube.com/@kyclark/playlists)
...
* PyCharm
  ...
  * [내가 사용하는 Pycharm Extensions](https://cliearl.github.io/posts/etc/pycharm-extensions/)
  * [PyCharm에서 tftpl 확장자 인식 시키기](https://jybaek.tistory.com/1018)
...
* [Django Performance Improvements - Part 1: Database Optimizations | Product Blog • Sentry](https://blog.sentry.io/2022/06/10/django-performance-improvements-part-1-database-optimizations/)
* [Django Performance Improvements - Part 2: Code Optimization | Product Blog • Sentry](https://blog.sentry.io/2022/07/05/django-performance-improvements-part-2-code-optimization/)
* [Django Performance Improvements - Part 3: Frontend Optimizations | Product Blog • Sentry](https://blog.sentry.io/2022/08/16/django-improvements-part-3-frontend-optimizations/)
* [Django Performance Improvements - Part 4: Caching in Django Applications | Product Blog • Sentry](https://blog.sentry.io/2022/10/24/django-performance-improvements-part-4-caching-in-django-applications/)
...
* [CS50: Web Programming with Python](https://www.youtube.com/playlist?list=PLBHVuYlKEkUJwwwMQQIYBT-f-SaILe7mn)
  ...
  * [CS50's Introduction to Artificial Intelligence with Python | Harvard University](https://pll.harvard.edu/course/cs50s-introduction-artificial-intelligence-python/2023-05)
...
* [장고(django) 설치하기](https://deku.posstree.com/ko/django/installation)
* [장고(django) 프로젝트 시작하기](https://deku.posstree.com/ko/django/start/)
* [장고(django) 모델(models) 사용해보기](https://deku.posstree.com/ko/django/models/)
* [장고(django)의 관리자 페이지](https://deku.posstree.com/ko/django/admin/)
* [장고(django)의 라우팅(Routing)](https://deku.posstree.com/ko/django/routing)
* [장고(django)의 ORM](https://deku.posstree.com/ko/django/orm/)
* [장고(django)의 뷰(View)](https://deku.posstree.com/ko/django/view/)
* [장고(django)의 폼(Form)](https://deku.posstree.com/ko/django/form/)
* [장고(django) 프로젝트를 헤로쿠(Heroku)에 업로드하기](https://deku.posstree.com/ko/django/heroku/)
* [장고(django) 프로젝트에 마스터 데이터 넣기](https://deku.posstree.com/ko/django/data-seed/)
* [장고(django)의 모델(Models)을 JSON으로 응답(Response)하기](https://deku.posstree.com/ko/django/response-model-to-json/)
* [장고(django)에 JWT 사용하기](https://deku.posstree.com/ko/django/jwt/)
* [장고(django)의 커스텀 유저 모델(Custom User Model)](https://deku.posstree.com/ko/django/custom-user-model/)
...
* [PyCon Korea 2025 Django, AI 시대를 위한 가장 실용적인 선택 - 이진석 - YouTube](https://www.youtube.com/watch?v=i8ZQvZNxQKQ)
  * [Django, AI 시대를 위한 가장 실용적인 선택 - 이진석 (PyCon Korea 2025)](https://livewiki.com/ko/content/django-ai-practical-choice)
...
* pytest
  ...
  * [A Beginner's Guide to Unit Testing with Pytest | Better Stack Community](https://betterstack.com/community/guides/testing/pytest-guide/)
...
* [간단히 정리한 Flask 강좌](https://webnautes.kr/gandanhi-jeongrihan-flask-gangjwa/)
...
* [How to build a cross-platform graphical user interface with Python — Russell Keith-Magee - YouTube](https://www.youtube.com/watch?v=nbJrfXkotq0)
  * [파이썬 BeeWare로 크로스 플랫폼 GUI 앱 개발하기](https://livewiki.com/ko/content/python-gui-cross-platform-2)
...
* [PyAutoGUI - Cross-platform GUI automation for human beings](http://pyautogui.readthedocs.io)
  ...
  * [Control Your Computer with Python - YouTube](https://www.youtube.com/watch?v=ByIdnfMFG3E)
...
* [PyUIBuilder: Python GUI builder. GUI builder for Tkinter, CustomTkinter, Kivy and PySide (upcoming)](https://github.com/PaulleDemon/PyUIBuilder)
  * [This tool lets you create your Python GUIs... - Python Programming | Facebook](https://www.facebook.com/Pythontutorial4u/posts/pfbid07weotm4CAVs8B6Jq9457DGnU6BP5p8ZtCwaB4zFBsRZpaimgy2LBBKEaKosuVZJcl)
* tkinter
  ...
  * [Create Stunning Python GUIs in 10 Minutes With Drag & Drop - YouTube](https://www.youtube.com/watch?v=NVPibVfFVtM) figma
    * [VidiGo Create Stunning Python GUIs in 10 Minutes With Dra](https://vidigo.ai/share/summary/386c1822194d)
...
* [ipywidgets](https://ipywidgets.readthedocs.io)
  ...
  * [Jupyter Notebook 인터렉티브(interactive) 기능 추가 - ipywidgets](https://devocean.sk.com/blog/techBoardDetail.do?ID=164623)
  * [Interactive Controls in Jupyter Notebooks](https://towardsdatascience.com/interactive-controls-for-jupyter-notebooks-f5c94829aee6)
...
* [anaconda - http://continuum.io/downloads](http://continuum.io/downloads)
  ...
  * Conda Package Repository
    ...
    * [Unlocking Hidden Power of Conda with Pixi — Ruben Arts, Julian Hofer - YouTube](https://www.youtube.com/watch?v=HOqv3kh4z_c)
      * [Conda의 숨겨진 힘을 해제하고 Pixi로 패키지 및 워크플로우를 관리하는 방법 - Ruben Arts, Julian Hofer](https://livewiki.com/ko/content/conda-pixi-ruben-julian)
...
* [fieldenum: Rust-like fielded Enum in Python](https://github.com/ilotoki0804/fieldenum)
  * [fieldenum/docs/README-ko.md at master · ilotoki0804/fieldenum · GitHub](https://github.com/ilotoki0804/fieldenum/blob/master/docs/README-ko.md)
  * [fieldenum: 파이썬에서의 러스트식 필드형 enum 지원 | GeekNews](https://news.hada.io/topic?id=15117)
...
* [cython](http://cython.org)
  ...
  * [Python 고성능 Python을 위한 Cython 활용하기 1편](https://devocean.sk.com/blog/techBoardDetail.do?ID=164580)
  * [Python 고성능 Python을 위한 Cython 활용하기 2편](https://devocean.sk.com/blog/techBoardDetail.do?ID=164605)
  * [Python 고성능 Python을 위한 Cython 활용하기 3편](https://devocean.sk.com/blog/techBoardDetail.do?ID=164733)
  * [python/c CYTHON 입문자를 위한 Q＆A](https://devocean.sk.com/blog/techBoardDetail.do?ID=165190)
...
* [Prefect - The New Standard in Dataflow Automation - Prefect](https://www.prefect.io/) Workflow Management System e.g. Luigi, Airflow
  ...
  * [Prefect - Quick Review](https://dailyheumsi.tistory.com/264)
  * [Jeff Hale - Better Python Coding with Prefect Blocks | PyData Global 2022 - YouTube](https://www.youtube.com/watch?v=NgrPvpEt3bE)
...
* SQLAlchemy
  ...
  * [SQLAlchemy ORM: Session & Unit of Work](https://devroach.hashnode.dev/sqlalchemy-orm-session-unit-of-work)
...
* [Pillow, the friendly PIL fork](https://python-pillow.org/)
  ...
  * [Start Using the Pillow Library to Process Images in Python - YouTube](https://www.youtube.com/watch?v=DWymRxeR-tk)
...
* [Fixit 2: Meta’s next-generation auto-fixing linter - Engineering at Meta](https://engineering.fb.com/2023/08/07/developer-tools/fixit-2-linter-meta/)
  * Meta에서 새로운 Python linter인 Fixit 2 공개
  * Python에는 Flake8이 있고 Meta에서도 많이 사용해 왔고 기여
    * 어려운 부분이 있었는데 새로운 린트 규칙을 추가하려면 전체를 다시 빌드해야 했고
    * 변경 사항을 제공하지 않아서 고칠 때 어려움이 있었고
    * 미래의 문법을 분석할 수 없어서 Python의 새로운 기능이 나와도 기다려야 했음
...
## Library Network
* [Requests vs Httpx vs Aiohttp | Which One to Pick? - YouTube](https://www.youtube.com/watch?v=OPyoXx0yA0I)
  * [examples/2023/httpx at main · ArjanCodes/examples](https://github.com/ArjanCodes/examples/tree/main/2023/httpx)
...
* [HTTPX](https://www.python-httpx.org/)
  * [HTTPX: 파이썬 HTTP 클라이언트](https://scshim.tistory.com/580)
  * [HTTP Client 성능 비교 - httpx, aiohttp, requests | 태주네 블로그](https://taejoone.jeju.onl/posts/2022-10-02-python-http-client-sync-async/)
...
* [yen: Create virtual environments for any Python version, without needing Python installed](https://github.com/tusharsadhwani/yen)
...
* Ray [Welcome to the Ray documentation — Ray 2.3.0](https://docs.ray.io/)
  ...
  * [Tristan West - Large scale agent-based simulations - PyData London 2023 - YouTube](https://www.youtube.com/watch?v=jhbHC1O0TZ8)
...
* [Creating QR Codes with Python - YouTube](https://www.youtube.com/watch?v=Z82KTydi7Eo)
...
* [click: Python composable command line interface toolkit](https://github.com/pallets/click/)
  ...
  * [Build AWESOME CLIs With Click in Python - YouTube](https://www.youtube.com/watch?v=FWacanslfFM)
    * [examples/2024/python_cli/notes at main · ArjanCodes/examples](https://github.com/ArjanCodes/examples/tree/main/2024/python_cli/notes)
* [Cookiecutter: Better Project Templates](https://cookiecutter.readthedocs.io/)
  * [Cookiecutter - 지겨운 프로젝트 세팅은 이제 그만하자..! | Call Me Maru](https://callmemaru.com/posts/introduce-cookiecutter/)
  * [cookiecutter를 이용해 템플릿 만들고 웹 배포하기](https://devocean.sk.com/blog/techBoardDetail.do?ID=164671)
  * [HelloCookieCutter1: The most basic template, for learning about Cookiecutter](https://github.com/BruceEckel/HelloCookieCutter1)
* curses
...
* [모놀리식에서 MSA로 가는 여정, 조민우 - PyCon Korea 2022 - YouTube](https://www.youtube.com/watch?v=RqjgteEVj1I)
...
* [klongpy: High-Performance Klong array language in Python](https://github.com/briangu/klongpy)
  * [klongpy - 파이썬용 고속 어레이 프로그래밍 언어 | GeekNews](https://news.hada.io/topic?id=18211)
...
* [Top Five Tricks for Coding in Pandas — with Matt Harrison - YouTube](https://www.youtube.com/watch?v=AsvqxJaO43g)
* [So You Wanna Be a Pandas Expert? (Tutorial) - James Powell | PyData Global 2021 - YouTube](https://www.youtube.com/watch?v=pjq3QOxl9Ok)
...
* [25 Nooby Pandas Coding Mistakes You Should NEVER make. - YouTube](https://www.youtube.com/watch?v=_gaAoJBMJ_Q)
...
* [Matt Harrison - An Introduction to Pandas 2, Polars, and DuckDB | PyData Global 2023 - YouTube](https://www.youtube.com/watch?v=vy8VrhaYR2M)
* [Giles Weaver & Ian Ozsvald - Pandas 2, Dask or Polars? Tackling larger data on a single machine - YouTube](https://www.youtube.com/watch?v=Qp3XZeB15lA)
...
* [FireDucks](https://fireducks-dev.github.io/)
  * [pandas의 100배 속도, 파이썬 데이터 분석의 혁신 fireducks!](https://stock79.tistory.com/entry/pandas%EC%9D%98-100%EB%B0%B0-%EC%86%8D%EB%8F%84-%ED%8C%8C%EC%9D%B4%EC%8D%AC-%EB%8D%B0%EC%9D%B4%ED%84%B0-%EB%B6%84%EC%84%9D%EC%9D%98-%ED%98%81%EC%8B%A0-fireducks)
* [Season6 데이타 사이언스 - YouTube](https://www.youtube.com/playlist?list=PLqba2bt00jhHQuE_vqn_h9fzN6pituBqx)
...
* [Modin: Speed up your Pandas workflows by changing a single line of code](https://github.com/modin-project/modin)
  ...
  * [A way to optimize Modin DataFrame – Passion is like genius; a miracle.](https://mkseo.pe.kr/blog/?p=4494)
...
* [Narwhals](https://narwhals-dev.github.io/narwhals/)
  ...
  * [Narwhals: enabling universal dataframe support - YouTube](https://www.youtube.com/watch?v=qOJiQtqI348)
    * [Narwhals: 범용 데이터프레임 지원을 위한 통일된 API](https://livewiki.com/ko/content/narwhals-dataframe-support)
...
* [Polars](https://www.pola.rs/)
  ...
  * [Emanuele Fabbiani - Advanced Polars: Lazy Queries and Streaming Mode - YouTube](https://www.youtube.com/watch?v=NjczVYbtfbg)
    * [고급 Polars: Lazy 쿼리 및 스트리밍 모드](https://livewiki.com/ko/content/emanuele-fabbiani-polars-lazy-streaming)
...
* [bolt-python: A framework to build Slack apps using Python](https://github.com/SlackAPI/bolt-python)
  * [Slack | Bolt for Python](https://slack.dev/bolt-python/concepts)
  * [Automate the Boring Stuff with Slackbot(ver.2) - presented by Takanori Suzuki - YouTube](https://www.youtube.com/watch?v=3k7qHhUHuP8)
...
* [Testing with Python (part 6): Fake it... - Bite code!](https://www.bitecode.dev/p/testing-with-python-part-6-fake-it)
...
* [(1) TestDriven.io on X: "Python clean test tip: The tests we write should cover: - all happy paths - edge/corner/boundary cases - negative test cases - security and illegal issues 👇 https://t.co/Ax1OqmxTIt" / X](https://x.com/testdrivenio/status/1795136382329028865)
...
* [mypy](http://mypy-lang.org/) an experimental optional static type checker for Python
  ...
  * [PyCon KR 2023 mypy에 올라타서 함수 호출자를 재귀적으로 탐색하기 양경모 - YouTube](https://www.youtube.com/watch?v=DMm41d8XKIE)
...
* [pydantic - Data validation and settings management using python 3.6 type hinting](https://docs.pydantic.dev/)
  ...
  * [Pydantic Data Validation & Python Web Security Practices | Real Python Podcast #202 - YouTube](https://www.youtube.com/watch?v=vFRkOk3NYLg)
