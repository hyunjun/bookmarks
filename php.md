...
* [레거시 PHP에서 모던 PHP로 – 뷰 분리하기 - 용균](https://edykim.com/ko/post/legacy-php-to-modern-php-split-views/)
...
* [제네릭 없는 PHP 인터페이스 - 용균](https://edykim.com/ko/post/php-interface-without-generics/)
...
* [ReactPHP의 Process로 pipe 사용하기 - 용균](https://edykim.com/ko/post/using-pipe-with-reactphp-process/)
* [PHP에서 커링 currying 함수 작성하기 - 용균](https://edykim.com/ko/post/writing-a-curling-currying-function-in-php/)
* [php callable 살펴보기 - 용균](https://edykim.com/ko/post/a-look-at-php-callable/)
...
* composer
  * [레거시 php 프로젝트를 composer 패키지로 바꾸기 - 용균](https://edykim.com/ko/post/replace-a-legacy-php-project-with-a-composer-package/)
...
* Laravel
  ...
  * [앤서블&라라독 vagrant와 앤서블(Ansible)을 이용하여 만든 가상 머신(guest system)에 라라독(Laradock)을 이용하여 라라벨(Laravel) 개발 환경을 구성해봅시다](https://deku.posstree.com/ko/environment/ansible-laradock/)
...
* phan
  * [PHP 함수 타입 선언과 정적분석도구 phan 활용하기 - 용균](https://edykim.com/ko/post/using-php-function-type-declaration-and-static-analysis-tool-phan/)
