...
* [알람에 관하여 | 우아한형제들 기술블로그](https://techblog.woowahan.com/2669/)
* [간단하게 만드는 이상한 알람 | 우아한형제들 기술블로그](https://techblog.woowahan.com/2679/)
...
* [모니터링 구글이 알려준 꼭 봐야할 지표 4가지 | 멤버십 영상 - YouTube](https://www.youtube.com/watch?v=PcmxhM5YoN4)
  * 코딩하는기술사. 구글(SRE)이 제시하는 모니터링 핵심 지표 4가지를 아키텍트 관점에서 해설하는 멤버십 영상
...
* [Beszel | Simple, lightweight server monitoring](https://beszel.dev/)
  * [Using Beszel to monitor Windows](https://blog.ktz.me/using-beszel-to-monitor-windows/)
  * [Beszel - The easiest monitoring solution you've probably never heard of for Windows, Linux and Mac! - YouTube](https://www.youtube.com/watch?v=O_9wT-5LoHM)
    * [video-code-snippets/2025-01-beszel/beszel-hub at main · tailscale-dev/video-code-snippets · GitHub](https://github.com/tailscale-dev/video-code-snippets/tree/main/2025-01-beszel/beszel-hub)
...
* datadog [Cloud Monitoring as a Service | Datadog](https://www.datadoghq.com/)
  ...
  * [Datadog Live with Devsisters 돌아보기](https://tech.devsisters.com/posts/datadog-live-talk/)
  * [Best practices for modern frontend monitoring | Datadog](https://www.datadoghq.com/blog/modern-frontend-monitoring/)
...
# Observability
* [서버 모니터링 분석 가이드 | kciter.so](https://kciter.so/posts/server-monitoring-analysis-guide/)
  * 서버 개발자를 위한 모니터링 종합 가이드. 장애 발생 시 빠르게 원인을 좁히고 사전에 문제를 파악하는 방법을 아키텍처·모니터링 관점에서 정리
...
* [VictoriaMetrics로 모든 앱 모니터링하기 | NAVER D2](https://d2.naver.com/helloworld/6475419)
