...
* [JWT vs 세션, 아직도 헷갈리세요? #JWT #세션인증 - YouTube](https://www.youtube.com/shorts/LnRxrKGJ5kQ)
...
* [JSON Query - a small, flexible, and expandable JSON query language](https://jsonquerylang.org/)
  * [jsonquery: A lightweight, flexible, and expandable JSON query language](https://github.com/jsonquerylang/jsonquery)
    * [JSON Query - 작고 유연하며 확장 가능한 JSON 쿼리 언어 | GeekNews](https://news.hada.io/topic?id=24305)
