...
* [MSA 서비스간 API 참조 가이드 (성능 튜닝) - Part1 일괄 조회](https://blog.naver.com/wharup/223188187194)
* [MSA 서비스간 API 참조 가이드 (성능 튜닝) - Part2 로컬 캐시](https://blog.naver.com/wharup/223195089165)
