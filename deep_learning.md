...
* [openai.com](https://openai.com)
  ...
  * [Introducing AgentKit | OpenAI](https://openai.com/index/introducing-agentkit/)
    ...
    * [류내원 - 오픈AI, AI 에이전트 구축·배포용 개발자 도구 '에이전트키트(AgentKit)' 출시 (출처: 뉴스)... | Facebook](https://www.facebook.com/story.php?story_fbid=24587354694220599&id=100001182289254)
  ...
  * OpenAI DevDay 2025
    ...
    * [(한글자막) OpenAI DevDay 2025 - YouTube](https://www.youtube.com/watch?v=bSM9or0pRVM)
      * [Minho Hwang - OpenAI DevDay 2025: 앱스 SDK, 에이전트킷, 코덱스 등 OpenAI가... | Facebook](https://www.facebook.com/100000303155893/posts/25113959708197455/)
  ...
  * [GPT 4.1 in the API - YouTube](https://www.youtube.com/watch?v=kA-P9ood-cE)
    * [소프트웨어 개발에 특화된 GPT4.1 출시 :: ROBOCO](https://roboco.io/posts/gpt4/)
    * [오픈AI, 코드·명령어 이해·긴 맥락 처리 능력 대폭 향상된 'GPT-4.1' 공개...기존 128000토큰 한계, 완전히 넘어섰다 < 자연어 < AI Tech < 기사본문 - 인공지능신문](https://www.aitimes.kr/news/articleView.html?idxno=34610)
  ...
  * [swarm: Educational framework exploring ergonomic, lightweight multi-agent orchestration. Managed by OpenAI Solution team](https://github.com/openai/swarm)
    * [swarm: 가벼운 멀티에이전트 오케스트레이션을 탐구하는 교육 프레임워크입니다. OpenAI 솔루션 팀에서 관리합니다](https://github.com/teddylee777/swarm)
    * [LangChain KR | OpenAI 에서 공개한 멀티에이전트 협업 프레임워크인 SWARM 핵심 기능 소개 및 데모 영상을 제작하여 공유 드립니다 | Facebook](https://www.facebook.com/groups/langchainkr/posts/3193869460748764/)
      * [#OpenAI #SWARM 핵심 기능 리뷰와 멀티에이전트 시스템 찍먹! - YouTube](https://www.youtube.com/watch?v=iqXn6Oiis4Q)
...
* [Touching the Elephant - TPUs | Consider the Bulldog](https://considerthebulldog.com/tte-tpu/)
  * [구글의 Tensor Processing Unit 이해하기 | GeekNews](https://news.hada.io/topic?id=25083)
...
* [onnx.ai](https://onnx.ai)
  ...
  * [퓨리오사 Furiosa NPU용 코딩 시리즈-.. : 네이버블로그](https://blog.naver.com/ulsancoding/223851247737)
  * [퓨리오사 Furiosa NPU용 코딩 시리즈-.. : 네이버블로그](https://blog.naver.com/ulsancoding/223857728216)
  * [onnxmltools: ONNXMLTools enables conversion of models to ONNX](https://github.com/onnx/onnxmltools)
...
* [CS 230 ― Deep Learning](https://stanford.edu/~shervine/teaching/cs-230.html)
  ...
  * [Stanford CS230: Deep Learning I Autumn 2025 - YouTube](https://www.youtube.com/playlist?list=PLoROMvodv4rNRRGdS0rBbXOUGA0wjdh1X)
...
* [Mamba: 트랜스포머에 도전하는 상태 공간 모델 | GeekNews](https://news.hada.io/topic?id=13538)
  ...
  * [Mamba Explained | Kola Ayonrinde](https://www.kolaayonrinde.com/blog/2024/02/11/mamba.html)
...
* [Mixture-of-Experts with Expert Choice Routing – Google AI Blog](https://ai.googleblog.com/2022/11/mixture-of-experts-with-expert-choice.html)
  ...
  * [Mixture of Experts (MoE) are dominating the LLM landscape](https://www.linkedin.com/posts/philipp-schmid-a6a2bb196_mixture-of-experts-explained-activity-7179478562398187520-dbzM/)
  * [Mixture of Experts Explained](https://huggingface.co/blog/moe)
  * [Omar Sanseviero on X: "Apropos of nothing, here is a mini-tutorial on three types of Mixture of Experts (MoE): Pre-trained MoE, upcycled MoEs, and FrankenMoEs. MoE refresher MoEs replace the feed-forward layers with sparse MoE layers. These layers contain a certain number of experts (e.g. 8), each one… https://t.co/CHWzTQgPVK" / X](https://twitter.com/osanseviero/status/1773360705682411750)
  * [MoEs papers reading list - a osanseviero Collection](https://huggingface.co/collections/osanseviero/moes-papers-reading-list-65a83f8a9aec16459920ffe0)
...
* [CS231n: Convolutional Neural Networks for Visual Recognition](http://cs231n.stanford.edu/syllabus.html)
  ...
  * [Stanford CS231N Deep Learning for Computer Vision I 2025 - YouTube](https://www.youtube.com/playlist?list=PLoROMvodv4rOmsNzYBMe0gJY2XS8AQg16)
...
* [Barebone Implementation of Every Transformer Component | by Katherine Oluwadarasimi Olowookere | Oct, 2025 | Medium](https://medium.com/@katherineolowookere/barebone-implementation-of-every-transformer-component-9d7ab56aa9e2)
  * [Barebone Implementation of Every Transformer Component | 박상길](https://www.linkedin.com/posts/%EC%83%81%EA%B8%B8-%EB%B0%95-b6ab145a_barebone-implementation-of-every-transformer-activity-7384692752439152640-SEu4)
    * Transformer는 자연어 처리에 혁신을 가져온 모델로, 토큰화부터 임베딩, 포지셔널 인코딩, 어텐션 메커니즘까지 각 구성 요소가 순차적으로 작동
    * 이러한 핵심 구성 요소를 NumPy와 PyTorch로 직접 구현하며 직관적으로 설명
* [Better Attention is All You Need - YouTube](https://www.youtube.com/watch?v=MNSmOih_pmg)
* [딥러닝 Attention is all you need 논문 번역 - 로스카츠의 AI 머신러닝](https://losskatsu.github.io/machine-learning/attention-is-all-you-need/)
...
* [flash-attention: Fast and memory-efficient exact attention](https://github.com/Dao-AILab/flash-attention)
  * [Flash Attention - 더 빠르고 효율적인 Attention 메커니즘](https://www.notion.so/Flash-Attention-Attention-1c9e323ea2b58096b80bebc3f60c0da8)
...
* [The Second Half – Shunyu Yao – 姚顺雨](https://ysymyth.github.io/The-Second-Half/)
  * [Universal verifier 같은 도구, world model 기반 연구들이 더해지면서 앞으로 RL은 전반기와는 완전히 다른 게임을 만들어낼 것이고, ‘상업화’라는 새로운 국면을 본격적으로 열어갈 것](https://www.linkedin.com/posts/dongsoo-lee-45028017_the-second-half-activity-7367014935899410433-OJzV/)
...
* [DAPO: An Open-source RL System from ByteDance Seed and Tsinghua AIR](https://github.com/BytedTsinghua-SIA/DAPO)
  * [바이트댄스, 딥시크도 감춘 추론 '강화학습법' 오픈 소스 공개 < 뉴테크 < 기술 < 기사본문 - AI타임스](https://www.aitimes.com/news/articleView.html?idxno=168989)
...
* [awesome-nano-banana: Awesome curated collection of images and prompts generated by gemini-2.5-flash-image (aka Nano Banana) state-of-the-art image generation and editing model. Explore AI generated visuals created with Gemini, showcasing Google’s advanced image generation capabilities](https://github.com/JimmyLv/awesome-nano-banana/)
  * [제미니용 40+ 나노 바나나 프로 프롬프트(복사 및 붙여넣기)](https://www.fotor.com/ko/blog/nano-banana-model-prompts/)
* [Awesome-Nano-Banana-images: A curated collection of fun and creative examples generated with Nano Banana🍌, Gemini-2.5-flash-image based model. This repository showcases diverse AI-generated visuals and prompts, highlighting the playful possibilities of Nano Banana](https://github.com/PicoTrex/Awesome-Nano-Banana-images)
  * [Awesom-Nano-Banana-Images | GeekNews](https://news.hada.io/topic?id=23044)
* [awesome-nano-banana-pro: Awesome curated collection of images and prompts built with the soon-to-launch Nano Banana Pro model. Browse limited early-access test cases that highlight Nano Banana Pro’s strengths in consistent, high-quality AI visual generation and editing](https://github.com/muset-ai/awesome-nano-banana-pro)
...
* [Black Forest Labs - Frontier AI Lab](https://blackforestlabs.ai/)
  * [Flux - 12B 파라미터 오픈소스 Text-To-Image 모델 | GeekNews](https://news.hada.io/topic?id=16129)
    ...
    * [최고의 AI 생성 모델 Flux의 모든것 - 필요한 모든걸 자세하게 설명합니다. - YouTube](https://www.youtube.com/watch?v=tYTBiicowT0)
    * [사람 프롬프트와 해부학적 이해도가 높은 모델 Flux.1 출시로 희망이 생긴다. (사용방법 소개) - YouTube](https://www.youtube.com/watch?v=b50q8929uUQ)
    ...
    * [KREA](https://www.krea.ai/)
      * [엄청난 고성능을 요구하는 Flux를 무료로 생성해주는 이미지 생성형 AI 서비스, 무료로 하루에 24장씩 생성가능! - YouTube](https://www.youtube.com/watch?v=0Ggnsx8Huh4)
        ...
        * 고성능을 요구하는 모델이지만 개인용 컴퓨터에서 실행 가능
        * 크레아 AI를 통해 접속하여 로그인 후, 태그를 추가하고 원하는 사양을 선택하여 생성 가능
...
* [CLIP: Connecting Text and Images](https://openai.com/blog/clip/)
  ...
  * [clip4dm: Official PyTorch implementation of Extract Free Dense Misalignment from CLIP (AAAI'25)](https://github.com/naver-ai/clip4dm)
...
* [ComfyUI: The most powerful and modular stable diffusion GUI, api and backend with a graph/nodes interface](https://github.com/comfyanonymous/ComfyUI)
  * [ComfyUI와 Flux.1을 GPU 없이 설치하고 어느 장소에서나 빠르게 무료로 사용 - YouTube](https://www.youtube.com/watch?v=BO88suhhw6E)
  * [ComfyUI 이제 원클릭으로 설치가능 (ComfyUI Desktop) - YouTube](https://www.youtube.com/watch?v=wdvM3urQzRA)
  * [ComfyUI-MiniMaxH3-Prompt-Writer: Local multimodal MiniMax H3 prompt writer for ComfyUI, powered by Gemma 4 GGUF models](https://github.com/duckyshell/ComfyUI-MiniMaxH3-Prompt-Writer)
    * [ComfyUI에서 로컬 AI로 MiniMax H3 프롬프트를 만드는 H3 Prompt Writer | digitalbourgeois](https://digitalbourgeois.tistory.com/3505)
    * 로컬 Gemma 4 GGUF 모델로 크리에이티브 브리프+레퍼런스(이미지 9장·영상 3개·오디오 3개)에서 MiniMax H3용 프롬프트를 생성하는 ComfyUI 확장. 생성 프롬프트 직접 편집 가능, VRAM별 모델 선택. MiniMax H3 실행 기능은 없음(프롬프트 생성 전용)
...
* [Janus: Janus-Series: Unified Multimodal Understanding and Generation Models](https://github.com/deepseek-ai/Janus)
  ...
  * [🎨🤖Janus: DeepSeek AI의 최신 멀티모달 생성 모델 분석](https://fornewchallenge.tistory.com/entry/%F0%9F%8E%A8%F0%9F%A4%96Janus-DeepSeek-AI%EC%9D%98-%EC%B5%9C%EC%8B%A0-%EB%A9%80%ED%8B%B0%EB%AA%A8%EB%8B%AC-%EC%83%9D%EC%84%B1-%EB%AA%A8%EB%8D%B8-%EB%B6%84%EC%84%9D)
...
* MAI-Image-1
  ...
  * [AGI KR | MS, 자체 개발 첫 이미지 모델 'MAI-Image-1' 출시 (출처: 뉴스) | Facebook](https://www.facebook.com/groups/agikr/permalink/2754578578216516/)
* [Midjourney](https://www.midjourney.com/)
  ...
  * [미드저니 개인화 모델 출시 사용방법 - YouTube](https://www.youtube.com/watch?v=OiOSYZzDz0g)
  * [Midjourney 웹 버전, 이제 모두가 사용 가능 | GeekNews](https://news.hada.io/topic?id=16422)
...
* [stable diffusion 2.0 코랩+그라디오 웹앱으로 만들어보기 - YouTube](https://www.youtube.com/watch?v=HgKuI-Ye0YI)
  ...
  * [stable-diffusion-webui: Stable Diffusion web UI](https://github.com/AUTOMATIC1111/stable-diffusion-webui)
    * [FREE Local Image Gen on Apple Silicon | FAST! - YouTube](https://www.youtube.com/watch?v=Ic5BRW_nLok)
  * [stable-diffusion-webui-colab: stable diffusion webui colab](https://github.com/camenduru/stable-diffusion-webui-colab)
  * stability matrix [Lykos AI](https://lykos.ai/)
...
* [StoryDiffusion: Consistent Self-Attention for Long-Range Image and Video Generation](https://storydiffusion.github.io/)
  * [NEW Open Source AI Video (Multi-Consistent Characters + 30 Second Videos +More) - YouTube](https://www.youtube.com/watch?v=jZWRENqCl6I)
    * [VidiGo NEW Open Source AI Video (Multi-Consistent Charact](https://vidigo.ai/share/summary/066db0cf4924)
    * [새로운 오픈 소스 AI 비디오가 최고입니다! | 완벽한 영상요약, 릴리스에이아이 | Lilys AI](https://lilys.ai/digest/600489)
* [SUPIR - XPixel Group](https://supir.xpixel.group/)
  * [이미지 업스케일링 끝판왕 - SUPIR (스테이블 디퓨전) - YouTube](https://www.youtube.com/watch?v=FxYnHqijgAc)
...
* [KLING AI: Next-Generation AI Creative Studio](https://klingai.com/)
  ...
  * [이젠 뮤비까지 만들어 버리네요… 가수 HYNN 박혜원 신곡 '영하' AI로 뮤직비디오 제작한 충격 후기 - YouTube](https://www.youtube.com/watch?v=iIE3vONbHcQ)
* [LongLive: Real-time Interactive Long Video Generation | NVIDIA](https://nvlabs.github.io/LongLive/)
...
* [Sora](https://openai.com/sora)
  ...
  * [Sora-2-api: Sora 2 api access using http://muapi.ai ](https://github.com/SamurAIGPT/Sora-2-api)
...
* [VOID: Video Object and Interaction Deletion](https://github.com/netflix/void-model)
  ...
  * Netflix의 비디오 인페인팅 모델. 객체 제거 시 물리적 상호작용을 현실적으로 시뮬레이션(지지하는 사람 제거 시 물체 낙하 등). CogVideoX 기반, quadmask 컨디셔닝, 384x672 해상도·최대 197프레임
