...
* [jmtd → log → How many function arguments?](https://jmtd.net/log/how_many_arguments/)
...
* [jmtd → log → template haskell → using Template Haskell to generate boilerplate](https://jmtd.net/log/template_haskell/boilerplate/)
